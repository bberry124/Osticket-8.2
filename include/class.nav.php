...
class StaffNav {
    ...
    function getTabs(){
        if(!isset($this->tabs)) {
            ...
            $this->tabs['customers']=array('desc'=>__('Customers'),'href'=>'customers.php','title'=>__('Customers'));
			$this->tabs['suppliers']=array('desc'=>__('Suppliers'),'href'=>'suppliers.php','title'=>__('Suppliers'));
// --- end coderXO mod --- //
        }
