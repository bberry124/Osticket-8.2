  ...
  <div class="sticky bar">
    <div class="content">
      <div class="pull-right flush-right">
        ...
        <span class="action-button pull-right" data-placement="bottom" data-dropdown="#action-dropdown-more"
        ...
        <span class="action-button pull-right" data-placement="bottom" data-dropdown="#action-dropdown-print"
          data-toggle="tooltip" title="<?php echo __('Print'); ?>">
          <i class="icon-caret-down pull-right"></i>
          <a id="ticket-print" aria-label="<?php echo __('Print'); ?>"
            href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print"><i class="icon-print"></i></a>
        </span>
        <div id="action-dropdown-print" class="action-dropdown anchor-right">
          <ul>
            <li title="PDF File"><a class="no-pjax" target="_blank"
                href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print&notes=0&events=0"><i
                  class="icon-file-text-alt"></i> <?php echo __('Ticket Thread'); ?></a>
            <li title="PDF File"><a class="no-pjax" target="_blank"
                href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print&notes=1&events=0"><i
                  class="icon-file-text-alt"></i> <?php echo __('Thread + Internal Notes'); ?></a>
            <li title="PDF File"><a class="no-pjax" target="_blank"
                href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print&notes=1&events=1"><i
                  class="icon-file-text-alt"></i> <?php echo __('Thread + Internal Notes + Events'); ?></a>
              <?php if (extension_loaded('zip')) { ?>
            <li title="ZIP Archive"><a class="no-pjax" target="_blank"
                href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1"><i
                  class="icon-folder-close-alt"></i> <?php echo __('Thread + Internal Notes + Attachments'); ?></a>
            <li title="ZIP Archive"><a class="no-pjax" target="_blank"
                href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1&tasks=1"><i
                  class="icon-folder-close-alt"></i>
                <?php echo __('Thread + Internal Notes + Attachments + Tasks'); ?></a>
              <?php } ?>
          </ul>
        </div>
        <?php
        ...
        <a class="action-button pull-right ticket-action" id="ticket-transfer" data-placement="bottom"
          data-toggle="tooltip" title="<?php echo __('Transfer'); ?>" data-redirect="tickets.php"
        ...
        <span class="action-button pull-right" data-dropdown="#action-dropdown-assign" data-placement="bottom"
          data-toggle="tooltip" title=" <?php echo $ticket->isAssigned() ? __('Assign') : __('Reassign'); ?>">
          <i class="icon-caret-down pull-right"></i>
          <a class="ticket-action" id="ticket-assign" data-redirect="tickets.php"
        ...
        <div id="action-dropdown-assign" class="action-dropdown anchor-right">
          <ul>
            ...
            <li><a class="no-pjax ticket-action" data-redirect="tickets.php?id=<?php echo
                                                                                    $ticket->getId(); ?>"
                href="#tickets/<?php echo $ticket->getId(); ?>/claim"><i class="icon-chevron-sign-down"></i>
                <?php echo __('Claim'); ?></a>
              <?php
              } ?>
            <li><a class="no-pjax ticket-action" data-redirect="tickets.php"
                href="#tickets/<?php echo $ticket->getId(); ?>/assign/agents"><i class="icon-user"></i>
                <?php echo __('Agent'); ?></a>
            <li><a class="no-pjax ticket-action" data-redirect="tickets.php"
                href="#tickets/<?php echo $ticket->getId(); ?>/assign/teams"><i class="icon-group"></i>
                <?php echo __('Team'); ?></a>
          </ul>
        </div>
        <?php
        ...
        <div id="action-dropdown-more" class="action-dropdown anchor-right">
          <ul>
            ...
            if ($ticket->isOpen() && $isManager) {
              if (!$ticket->isOverdue()) { ?>
            <li><a class="confirm-action" id="ticket-overdue" href="#overdue"><i class="icon-bell"></i>
                <?php
            ...
            <?php if (
              ...
              if (!$emailBanned) { ?>
            <li><a class="confirm-action" id="ticket-banemail" href="#banemail"><i class="icon-ban-circle"></i>
                <?php echo sprintf(
            ...
            <li><a class="confirm-action" id="ticket-banemail" href="#unbanemail"><i class="icon-undo"></i>
                <?php echo sprintf(
            ...
            <li class="danger"><a class="ticket-action" href="#tickets/<?php
                ...
                data-redirect="tickets.php"><i class="icon-trash"></i>
                <?php
        ...
        <a href="#post-note" id="post-note" class="post-response action-button" data-placement="bottom"
          data-toggle="tooltip" title="<?php echo __('Post Internal Note'); ?>"><i class="icon-file-text"></i></a>
    ...
    <td width="50%">
      <table border="0" cellspacing="0" cellpadding="4" width="100%">
        <tr>
          ...
          <td>
            <a class="tickets-action" data-dropdown="#action-dropdown-statuses" data-placement="bottom"
              data-toggle="tooltip" title="<?php echo __('Change Status'); ?>"
              data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>" href="#statuses" onclick="javascript:
                                  saveDraft();">
        ...
        <tr>
          ...
          <td>
            <a class="ticket-action" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Transfer'); ?>"
              data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>"
              href="#tickets/<?php echo $ticket->getId(); ?>/transfer" onclick="javascript:
      ...
      <table border="0" cellspacing="0" cellpadding="4" width="100%">
        <tr>
          ...
          <td><a href="#tickets/<?php echo $ticket->getId(); ?>/user" onclick="javascript:
                ...
                id="user-<?php echo $ticket->getOwnerId(); ?>-name"><?php echo Format::htmlchars($ticket->getName());
                                                                                                                  ?></span></a>
            <?php
            if ($user) { ?>
            ...
            <div id="action-dropdown-org-stats" class="action-dropdown anchor-right">
              <ul>
                ...
                <li><a href="tickets.php?<?php echo Http::build_query(array(
                    ...
                    <?php echo __('All Tickets'); ?></a></li>
                <?php }
                  if ($thisstaff->hasPerm(User::PERM_DIRECTORY)) { ?>
                <li><a href="orgs.php?id=<?php echo $user->getOrgId(); ?>"><i
                      class="icon-building icon-fixed-width"></i>
                    <?php
        ...
        <table width='100%'>
          <tr>
            ...
            <td width="9%" align="right">
              <?php echo number_format((($rows['onsite_callout_fee_qty']) * ($rows['onsite_callout_fee'])), 2); ?></td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    <table align='left' width='80%'>
      ...
      <tr>
        ...
        <td align='left'><?php
          ...
          <a class="action-button" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=edit"><i
...
<ul class="tabs clean threads" id="ticket_tabs">
  <li class="active"><a id="ticket-thread-tab"
      href="#ticket_thread"><?php
  ...
  <div id="ticket_thread" class="tab_content">
    ...
    <div class="sticky bar stop actions" id="response_options">
      <ul class="tabs" id="response-tabs">
        ...
        <li class="active <?php
                            echo isset($errors['reply']) ? 'error' : ''; ?>"><a href="#reply"
      ...
      <form id="reply" class="tab_content spellcheck exclusive save"
        ...
        action="tickets.php?id=<?php
                                                                                                                                                                                                                          echo $ticket->getId(); ?>#reply"
        name="reply" method="post" enctype="multipart/form-data" style="display:block">
        <?php csrf_token(); ?>
            ...
            <tr>
              ...
              <td>
                ...
                <select id="emailreply" name="emailreply" style="width:40%;">
                  ...
                  <option value="0" <?php echo !$emailReply ? 'selected="selected"' : ''; ?>>&mdash;
                    <?php echo __('Do Not Email Reply'); ?> &mdash;</option>
                </select>
              </td>
            </tr>
          </tbody>
                ...
                <div id="ccs" class="hidden">
                  ...
                  <div id="action-dropdown-collaborators" class="action-dropdown anchor-right">
                    <ul>
                      ...
                      <li><a class="manage-collaborators"
                          href="#thread/<?php echo
                                                                              $ticket->getThreadId(); ?>/collaborators/1"><i class="icon-cog"></i>
                          <?php echo __('Manage Collaborators'); ?></a>
                    </ul>
                  </div>
                  <?php
                      } ?>
          ...
          <tbody id="resp_sec">
            ...
            <tr>
              <td colspan="2">
                ...
                <br />
                <textarea name="response" id="response" cols="50" data-signature-field="signature"
                  ...
                  rows="9" wrap="soft"
                  class="<?php if ($cfg->isRichTextEnabled()) {
                                                                                                                                                                                                                                                                                    echo 'richtext';
                                                                                                                                                                                                                                                                                  }                                                                                                                                                    ?> draft draft-delete fullscreen"
                  <?php
            ...
            <tr>
              <td width="120">
                <label for="signature" class="left"><strong><?php echo __('Signature'); ?>:</strong></label>
              </td>
              <td>
                <?php
      ...
      <form id="note" class="hidden tab_content spellcheck exclusive save"
        data-lock-object-id="ticket/<?php echo $ticket->getId(); ?>"
        data-lock-id="<?php echo $mylock ? $mylock->getId() : ''; ?>"
        action="tickets.php?id=<?php echo $ticket->getId(); ?>#note" name="note" method="post"
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          ...
          <tr>
            <td width="120" style="vertical-align:center">
            ...
            <td>
              <div>
                <div class="faded" style="padding-left:0.15em">
                  <?php
                    echo __('Note title - summary of the note (optional)'); ?>
                </div>
          ...
          <tr>
            <td colspan="2">
              ...
              <textarea name="note" id="internal_note" cols="80" placeholder="<?php echo __('Note details'); ?>"
                rows="9" wrap="soft"
                class="<?php if ($cfg->isRichTextEnabled()) {
                                                                                                                                                  echo 'richtext';
                                                                                                                                                } ?> draft draft-delete fullscreen"
                <?php
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        echo $attrs; ?>><?php echo ThreadEntryBody::clean($_POST ? $info['note'] : $draft); ?></textarea>
      ...
      <form id="signature" action="tickets.php?id=<?php echo $ticket->getId(); ?>#signature" name="signature"
        ...
        <?php csrf_token(); ?>
        <input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">
        <input type="hidden" name="msgId" value="<?php echo $cfg->getLockTime() * 60; ?>">
        <input type="hidden" name="a" value="signature">
        <input type="hidden" name="lockCode" value="<?php echo $mylock ? $mylock->getCode() : ''; ?>">
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <div class=" grid-container">
              <div class="item1"><strong>Signature:</strong></div>
              <div class="item2">
              ...
              <div class=" item7" style="padding: 1.25rem;font-size:.875rem">I confirm that the engineer
                ...
                services
                details in this job ticket. We are satisfied that the ticket has been completed and agree to pay
                the
                fees and
