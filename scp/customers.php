...
//            " 	service2_type7	 = '" . db_input($vars['service2_type7'], false) . "',  " .
            ...
            " 	ull_id1	     = '" . db_input($vars['ull_id1'], false) . "',  " .
            " 	ull_id2	     = '" . db_input($vars['ull_id2'], false) . "',  " .
            " 	ull_id3	     = '" . db_input($vars['ull_id3'], false) . "',  " .
            " 	ull_id4	     = '" . db_input($vars['ull_id4'], false) . "',  " .
            " 	ull_id5	     = '" . db_input($vars['ull_id5'], false) . "',  " .
            " 	ull_id6	     = '" . db_input($vars['ull_id6'], false) . "',  " .
            " 	ull_id7	     = '" . db_input($vars['ull_id7'], false) . "',  " .
            " 	technology_type1	     = '" . db_input($vars['technology_type1'], false) . "',  " .
            " 	technology_type2	     = '" . db_input($vars['technology_type2'], false) . "',  " .
            " 	technology_type3	     = '" . db_input($vars['technology_type3'], false) . "',  " .
            " 	technology_type4	     = '" . db_input($vars['technology_type4'], false) . "',  " .
            " 	technology_type5	     = '" . db_input($vars['technology_type5'], false) . "',  " .
            " 	technology_type6	     = '" . db_input($vars['technology_type6'], false) . "',  " .
            " 	technology_type7	     = '" . db_input($vars['technology_type7'], false) . "',  " .
            " 	mdf_pair_detailed1	     = '" . db_input($vars['mdf_pair_detailed1'], false) . "',  " .
            " 	mdf_pair_detailed2	     = '" . db_input($vars['mdf_pair_detailed2'], false) . "',  " .
            " 	mdf_pair_detailed3	     = '" . db_input($vars['mdf_pair_detailed3'], false) . "',  " .
            " 	mdf_pair_detailed4	     = '" . db_input($vars['mdf_pair_detailed4'], false) . "',  " .
