...
<div id="loginBox">
  ...
  <form action="login.php" method="post" id="login" onsubmit="attemptLoginAjax(event)">
    ...
    <fieldset style="padding-top:10px;">
      ...
      <button class="submit button pull-center" type="submit" name="submit"><i class="icon-signin"></i>
        <?php echo __('Verify'); ?>
      </button>
    </fieldset>
    <?php
    ...
    <fieldset>
      <input type="text" name="userid" id="name" value="<?php
                echo $info['userid'] ?? null; ?>" placeholder="<?php echo __('Email or Username'); ?>" autofocus
        autocorrect="off" autocapitalize="off">
      <input type="password" name="passwd" id="pass" maxlength="128" placeholder="<?php echo __('Password'); ?>"
        autocorrect="off" autocapitalize="off">
...
<div id="copyRights"><?php echo __('UC8 Australia Pty Ltd | 1994 – 2024 | Version 2.1'); ?> </div>
</body>
