...
class Ticket extends VerySimpleModel implements RestrictedAccess, Threadable, Searchable
{
    static $meta = array(
        'table' => TICKET_TABLE,
        'pk' => array('ticket_id'),
    ...
    public $owner; // TicketOwner
    public $_user; // EndUser
    public $_answers;
    public $collaborators;
    public $active_collaborators;
    public $recipients;
    public $lastrespondent;
    public $lastuserrespondent;
    public $_children;

    public function loadDynamicData($force = false)
    {
    ...
    public function getAnswer($field, $form = null)
    {
    ...
    public static function getMergeTypeByFlag($flag)
    {
    ...
    public static function isParentStatic($flag = false)
    {
    ...
    public function isChild($pid = false)
    {
    ...
    public function isAssigned($to = null)
    {
        if (!$this->isOpen()) {
            return false;
        }
    ...
    public function checkStaffPerm($staff, $perm = null)
    {
    ...
    // Deprecated
    public function getOldAuthToken()
    {
    ...
    public function getSLADueDate($recompute = false)
    {
        global $cfg;
    ...
    public function updateEstDueDate($clearOverdue = true)
    {
    ...
    public function getUpdateInfo()
    {
        ...
        $info = array('source' => $this->getSource(),
            'source_other' => $this->getSourceOther(),
            'topicId' => $this->getTopicId(),
            'slaId' => $this->getSLAId(),
            'phone' => $this->getPhone(),
            'phone_ext' => $this->getPhoneExt(),
// --- start coderXO mod --- //
            'carrier' => $this->getExtraData('carrier'),
            'carrier_ref' => $this->getExtraData('carrier_ref'),
            'mobile' => $this->getExtraData('mobile'),
            'contract' => $this->getExtraData('contract'),
            'address' => $this->getExtraData('address'),
            'suburb' => $this->getExtraData('suburb'),
...
// --- end coderXO mod --- //
    ...
    public function acquireLock($staffId, $lockTime = null)
    {
        global $cfg;
    ...
    public function releaseLock($staffId = false)
    {
    ...
    public function getExtraData($field)
    {
        ...
        if (in_array($field, array_keys($this->ht))) {
    ...
    public function getAssigned($glue = '/')
    {
    ...
    public function getLastRespondent()
    {
    ...
    public function getLastUserRespondent()
    {
    ...
    public function getLastRespDate()
    {
    ...
    public function getNumOpenTasks()
    {
    ...
    public function getClientThread()
    {
        return $this->getThreadEntries(array('M', 'R'));
    }

    public function getThreadEntry($id)
    {
        return $this->getThread()->getEntry($id);
    }

    public function getThreadEntries($type = false)
    {
        if ($this->getThread()) {
    ...
    public function getRecipients($who = 'all', $whitelist = array(), $active = true)
    {
    ...
    public function getNumActiveCollaborators()
    {
        return $this->getThread() ? $this->getThread()->getNumActiveCollaborators() : '';
    }

    public function getAssignmentForm($source = null, $options = array())
    {
        global $thisstaff;
    ...
    public function getReferralForm($source = null, $options = array())
    {
        global $thisstaff;
    ...
    public function getClaimForm($source = null, $options = array())
    {
        global $thisstaff;
    ...
    public function getTransferForm($source = null)
    {
        global $thisstaff;
    ...
    public function getDynamicFieldById($fid)
    {
    ...
    public function getDynamicFields($criteria = array())
    {
    ...
    public function hasClientEditableFields()
    {
    ...
    public static function getMissingRequiredFields($ticket, $ids = false)
    {
    ...
    public function getMissingRequiredField()
    {
        $fields = self::getMissingRequiredFields($this);
        return $fields ? $fields[0] : null;
    }

    public function addCollaborator($user, $vars, &$errors, $event = true)
    {
    ...
    public function addCollaborators($users, $vars, &$errors, $event = true)
    {
    ...
    //XXX: Ugly for now
    public function updateCollaborators($vars, &$errors)
    {
        global $thisstaff;
    ...
    public function getAuthToken($user, $algo = 1)
    {
    ...
    public function sendAccessLink($user)
    {
        global $ost;
    ...
    public function setMergeType($combine = false, $parent = false)
    {
    ...
    public function setLastMsgId($msgid)
    {
     ...
     *          considered.
     */
    public function selectSLAId($trump = null)
    {
        global $cfg;
    ...
    public function setStatus($status, $comments = '', &$errors = array(), $set_closing_agent = true, $force_close = false)
    {
    ...
    public function setState($state, $alerts = false)
    {
    ...
    public function setAnsweredState($isanswered)
    {
    ...
    public function onNewTicket($message, $autorespond = true, $alertstaff = true)
    {
        global $cfg;
    ...
    public function onOpenLimit($sendNotice = true)
    {
        global $ost, $cfg;
    ...
    public function onResponse($response, $options = array())
    {
        $this->isanswered = 1;
        $this->save();
     ...
     *
     */
    public function notifyCollaborators($entry, $vars = array())
    {
        global $cfg;
    ...
    public function onMessage($message, $autorespond = true, $reopen = true)
    {
        global $cfg;
    ...
    public function onActivity($vars, $alert = true)
    {
        global $cfg, $thisstaff;
    ...
    public function onAssign($assignee, $comments, $alert = true)
    {
        global $cfg, $thisstaff;
        ...
        //Assigned tickets must be open - otherwise why assign?
    ...
    public function onOverdue($whine = true, $comments = "")
    {
        global $cfg;
    ...
    public static function getVarScope()
    {
        $base = array(
    ...
    public static function supportsCustomData()
    {
        return true;
    }

    //Replace base variables.
    public function replaceVars($input, $vars = array())
    {
        global $ost;
    ...
    public function markOverdue($whine = true)
    {
        global $cfg;
    ...
    public function unlinkChild($parent)
    {
        $this->setPid(null);
        $this->setSort(1);
    ...
    public static function manageMerge($tickets)
    {
        global $thisstaff;
    ...
    public static function merge($tickets)
    {
        $options = $tickets;
    ...
    public function hasReferral($object, $type)
    {
    ...
    public function transfer($deptId, $comments, $alert = true) {
    ...
    public function claim(ClaimForm $form, &$errors)
    {
        global $thisstaff;
    ...
    public function assignToStaff($staff, $note, $alert = true, $user = null)
    {
    ...
    public function checkStaffAccess($staff)
    {
    ...
    public function assignToTeam($team, $note, $alert = true, $user = null)
    {
    ...
    public function assign(AssignmentForm $form, &$errors, $alert = true)
    {
        global $thisstaff;
    ...
    public function release(?array $info = array(), &$errors)
    {
    ...
    public function refer(ReferralForm $form, &$errors, $alert = true)
    {
        global $thisstaff;
    ...
    public function systemReferral($emails)
    {
        global $cfg;
    ...
    public function postMessage($vars, $origin = '', $alerts = true)
    {
        global $cfg;
    ...
    public function postCannedReply($canned, $message, $alert = true)
    {
        global $ost, $cfg;
    ...
    /* public */
    public function postReply($vars, &$errors, $alert = true, $claim = true)
    {
    ...
    public function logNote($title, $note, $poster = 'SYSTEM', $alert = true)
    {
    ...
    public function postThreadEntry($type, $vars, $options = array())
    {
        $errors = array();
        switch ($type) {
            case 'M':
    ...
    public function pdfExport($psize = 'Letter', $notes = false, $events = false)
    {
        global $thisstaff;
    ...
    public function zipExport($notes = true, $tasks = false)
    {
    ...
    public function save($refetch = false)
    {
        if ($this->dirty) {
    ...
    public function updateField($form, &$errors)
    {
        global $thisstaff, $cfg;
    ...
    public static function getIdByNumber($number, $email = null, $ticket = false)
    {
    ...
    public static function lookupByNumber($number, $email = null)
    {
    ...
    public static function getStaffStats($staff)
    {
    ...
    public static function getChildTickets($pid)
    {
     ...
     */
    public static function create($vars, &$errors, $origin, $autorespond = true,
        $alertstaff = true) {
    ...
    public static function open($vars, &$errors)
    {
        global $thisstaff, $cfg;
    ...
    public static function agentActions($agent, $options = array())
    {
        if (!$agent) {
            return;
        }
    ...
    public static function duedateField($name, $default = '', $hint = '')
    {
        return DateTimeField::init(array(
            'id' => $name,
            'name' => $name,
    ...
    public static function registerCustomData(DynamicForm $form)
    {
