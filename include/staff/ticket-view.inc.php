...
if ($ticket->isClosed() && !$ticket->isReopenable()) {
    ...
    $warn .= sprintf(
        '&nbsp;&nbsp;<span class="Icon assignedTicket">%s</span>',
        sprintf(
            __('Ticket is assigned to %s'),
        ...
        <div class="content">
            <div class="pull-right flush-right">
                ...
                <div id="action-dropdown-print" class="action-dropdown anchor-right">
                    <ul>
                        <li title="PDF File"><a class="no-pjax" target="_blank" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print&notes=0&events=0"><i class="icon-file-text-alt"></i> <?php echo __('Ticket Thread'); ?></a>
                        <li title="PDF File"><a class="no-pjax" target="_blank" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print&notes=1&events=0"><i class="icon-file-text-alt"></i> <?php echo __('Thread + Internal Notes'); ?></a>
                        <li title="PDF File"><a class="no-pjax" target="_blank" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=print&notes=1&events=1"><i class="icon-file-text-alt"></i> <?php echo __('Thread + Internal Notes + Events'); ?></a>
                            <?php if (extension_loaded('zip')) { ?>
                        <li title="ZIP Archive"><a class="no-pjax" target="_blank" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1"><i class="icon-folder-close-alt"></i> <?php echo __('Thread + Internal Notes + Attachments'); ?></a>
                        <li title="ZIP Archive"><a class="no-pjax" target="_blank" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1&tasks=1"><i class="icon-folder-close-alt"></i> <?php echo __('Thread + Internal Notes + Attachments + Tasks'); ?></a>
                        <?php } ?>
                    </ul>
                </div>
                <?php
                ...
                if ($role->hasPerm(Ticket::PERM_TRANSFER)) { ?>
                    <a class="action-button pull-right ticket-action" id="ticket-transfer" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Transfer'); ?>" data-redirect="tickets.php" href="#tickets/<?php echo $ticket->getId(); ?>/transfer"><i class="icon-share"></i></a>
                <?php
                } ?>
                ...
                if ($ticket->isOpen() && $role->hasPerm(Ticket::PERM_ASSIGN)) { ?>
                    <span class="action-button pull-right" data-dropdown="#action-dropdown-assign" data-placement="bottom" data-toggle="tooltip" title=" <?php echo $ticket->isAssigned() ? __('Assign') : __('Reassign'); ?>">
                        <i class="icon-caret-down pull-right"></i>
                        <a class="ticket-action" id="ticket-assign" data-redirect="tickets.php" href="#tickets/<?php echo $ticket->getId(); ?>/assign"><i class="icon-user"></i></a>
                    </span>
                    <div id="action-dropdown-assign" class="action-dropdown anchor-right">
                        <ul>
                            ...
                            if (
                                ...
                                <li><a class="no-pjax ticket-action" data-redirect="tickets.php?id=<?php echo
                                                                                                    $ticket->getId(); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/claim"><i class="icon-chevron-sign-down"></i> <?php echo __('Claim'); ?></a>
                                <?php
                            } ?>
                                <li><a class="no-pjax ticket-action" data-redirect="tickets.php" href="#tickets/<?php echo $ticket->getId(); ?>/assign/agents"><i class="icon-user"></i> <?php echo __('Agent'); ?></a>
                                <li><a class="no-pjax ticket-action" data-redirect="tickets.php" href="#tickets/<?php echo $ticket->getId(); ?>/assign/teams"><i class="icon-group"></i> <?php echo __('Team'); ?></a>
                        </ul>
                    </div>
                <?php
                } ?>
                <div id="action-dropdown-more" class="action-dropdown anchor-right">
                    <ul>
                        ...
                        if ($role->hasPerm(Ticket::PERM_EDIT)) { ?>
                            <li><a class="change-user" href="#tickets/<?php
                                                                        echo $ticket->getId(); ?>/change-user" onclick="javascript:
                        saveDraft();"><i class="icon-user"></i> <?php
                        ...
                        if ($ticket->isAssigned() && $canRelease) { ?>
                            <li><a href="#tickets/<?php echo $ticket->getId();
                                                    ?>/release" class="ticket-action" data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                        ...
                        if ($ticket->isOpen() && $canMarkAnswered) {
                            if ($ticket->isAnswered()) { ?>
                                <li><a href="#tickets/<?php echo $ticket->getId();
                                                        ?>/mark/unanswered" class="ticket-action" data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                                        <i class="icon-circle-arrow-left"></i> <?php
                                                                                echo __('Mark as Unanswered'); ?></a></li>
                            <?php
                            } else { ?>
                                <li><a href="#tickets/<?php echo $ticket->getId();
                                                        ?>/mark/answered" class="ticket-action" data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                        ...
                        if ($role->hasPerm(Ticket::PERM_REFER)) { ?>
                            <li><a href="#tickets/<?php echo $ticket->getId();
                                                    ?>/referrals" class="ticket-action" data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>">
                    ...
                    return false"><i class="icon-paste"></i> <?php echo __('Manage Forms'); ?></a></li>
                        ...
                        <?php if (
                            ...
                            if (!$emailBanned) { ?>
                                <li><a class="confirm-action" id="ticket-banemail" href="#banemail"><i class="icon-ban-circle"></i> <?php echo sprintf(
                                                                                                                                        Format::htmlchars(__('Ban Email <%s>')),
                                                                                                                                        $ticket->getEmail()
                                                                                                                                    ); ?></a></li>
                            <?php
                            } elseif ($unbannable) { ?>
                                <li><a class="confirm-action" id="ticket-banemail" href="#unbanemail"><i class="icon-undo"></i> <?php echo sprintf(
                        ...
                        if ($role->hasPerm(Ticket::PERM_DELETE)) {
                            ...
                            <li class="danger"><a class="ticket-action" href="#tickets/<?php
                                                                                        echo $ticket->getId(); ?>/status/delete" data-redirect="tickets.php"><i class="icon-trash"></i> <?php
                ...
                if ($role->hasPerm(Ticket::PERM_REPLY)) { ?>
                    <a href="#post-reply" class="post-response action-button" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Post Reply'); ?>"><i class="icon-mail-reply"></i></a>
                <?php
                } ?>
                <a href="#post-note" id="post-note" class="post-response action-button" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Post Internal Note'); ?>"><i class="icon-file-text"></i></a>
                <?php // Status change options
                echo TicketStatus::status_options();
                ?>
            </div>
            <div class="flush-left">
                <h2><a href="tickets.php?id=<?php echo $ticket->getId(); ?>" title="<?php echo __('Reload'); ?>"><i class="icon-refresh"></i>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="4" width="100%">
                <tr>
                    ...
                    if ($role->hasPerm(Ticket::PERM_CLOSE)) { ?>
                        <td>
                            <a class="tickets-action" data-dropdown="#action-dropdown-statuses" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Change Status'); ?>" data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>" href="#statuses" onclick="javascript:
                                  saveDraft();">
                ...
                <tr>
                    ...
                    if (
                        ...
                        <td>
                            <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Update'); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/field/<?php echo $pf->getId(); ?>/edit">
                ...
                <tr>
                    ...
                    if ($role->hasPerm(Ticket::PERM_TRANSFER)) { ?>
                        <td>
                            <a class="ticket-action" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Transfer'); ?>" data-redirect="tickets.php?id=<?php echo $ticket->getId(); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/transfer" onclick="javascript:
                                saveDraft();"><?php echo Format::htmlchars($ticket->getDeptName()); ?>
                            </a>
                        </td>
                    <?php
                    } else { ?>
        ...
        <td width="50%" style="vertical-align:top">
            <table border="0" cellspacing="0" cellpadding="4" width="100%">
                <tr>
                    <th width="120"><?php echo __('Contact Person'); ?>:</th>
                    <td><a href="#tickets/<?php echo $ticket->getId(); ?>/user" onclick="javascript:
                            saveDraft();
                            ...
                            return false;
                            "><i class="icon-user"></i> <span id="user-<?php echo $ticket->getOwnerId(); ?>-name"><?php echo Format::htmlchars($ticket->getName());
                                                                                                                    ?></span></a>
                        <?php
                        if ($user) { ?>
                            <a href="tickets.php?<?php echo Http::build_query(array(
                                                        'status' => 'open', 'a' => 'search', 'uid' => $user->getId(),
                                                    )); ?>" title="<?php echo __('Related Tickets'); ?>" data-dropdown="#action-dropdown-stats">
                            ...
                            <div id="action-dropdown-stats" class="action-dropdown anchor-right">
                                <ul>
                                    ...
                                    if (($open = $user->getNumOpenTickets())) {
                                        echo sprintf(
                                            '<li><a href="tickets.php?a=search&status=open&uid=%s"><i class="icon-folder-open-alt icon-fixed-width"></i> %s</a></li>',
                                            $user->getId(),
                    ...
                    <tr>
                        ...
                        <td><i class="icon-building"></i>
                            ...
                            <a href="tickets.php?<?php echo Http::build_query(array(
                                                    ...
                                                    )); ?>" title="<?php echo __('Related Tickets'); ?>" data-dropdown="#action-dropdown-org-stats">
                            ...
                            <div id="action-dropdown-org-stats" class="action-dropdown anchor-right">
                                <ul>
                                    ...
                                    if ($thisstaff->hasPerm(User::PERM_DIRECTORY)) { ?>
                                        <li><a href="orgs.php?id=<?php echo $user->getOrgId(); ?>"><i class="icon-building icon-fixed-width"></i> <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($role->hasPerm(Ticket::PERM_EDIT)) {
                            ...
                            <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Update'); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/field/source/edit">
                ...
                if ($ticket->isOpen()) { ?>
                    <tr>
                        ...
                        if ($role->hasPerm(Ticket::PERM_ASSIGN)) { ?>
                            <td>
                                <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Update'); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/assign">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($role->hasPerm(Ticket::PERM_EDIT)) {
                            ...
                            <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Update'); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/field/sla/edit">
                ...
                if ($ticket->isOpen()) { ?>
                    <tr>
                        ...
                        if ($role->hasPerm(Ticket::PERM_EDIT)) {
                            ...
                            <td>
                                <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Update'); ?>" href="#tickets/<?php echo $ticket->getId();
                                                                                                                                                        ?>/field/duedate/edit">
                                    <?php $due_date = Format::datetime($ticket->getEstDueDate()); ?>
                                    <span id="field_duedate" <?php if (!$due_date) {
                                                                    echo 'class="faded"';
                                                                }
                                                                ?>>
            ...
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    ...
                    if ($role->hasPerm(Ticket::PERM_EDIT)) {
                        ...
                        <td>
                            <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Update'); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/field/topic/edit">
                                <span id="field_topic">
...
<div id="div_style">
    <table id="myTable" bgcolor="#F8F8F8" width="100%" border="1" cellspacing="0">
        ...
        for ($j = 1; $j <= $bill_rows; $j++) {
            ...
            echo "<td align='center'>" . $rows['qty'] . "</td>";
            echo "<td align='left'>" . $rows['description'] . "</td>";
            echo "<td><table width='100%'><tr><td width='1%' align='left'>$</td><td width='9%' align='right'>" . $rows['unit_price'] . "</td></tr></table></td>";
    ...
    <table id='fixed_table' bgcolor="#F8F8F8" width="100%" border="1" cellspacing="0">
        <tr>
            ...
            <td align="center" width="5%"><?php echo $rows['labour_qty']; ?></td>
            ...
            <td>
                <table width="100%">
                    <tr>
                        ...
                        <td width="9%" align="right"><?php echo number_format($rows['labour_charge'], 2); ?></td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td>
                <table width="100%">
                    <tr>
                        <td width="1%" align="left">$</td>
                        <td width="9%" align="right"><?php echo number_format($rows['onsite_callout_fee'], 2); ?></td>
                    </tr>
                </table>
            </td>
            <td align="center" width="10%" bgcolor="#DDDDDD">
                <table width='100%'>
                    <tr>
                        <td width='1%' align='left'>$</td>
                        <td width="9%" align="right"><?php echo number_format((($rows['onsite_callout_fee_qty']) * ($rows['onsite_callout_fee'])), 2); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <td style="border: 1px solid black;" align="right" width="50%" bgcolor="#DDDDDD">
                    <font color="#0066CC">
                        <table width='100%' align='center'>
                            <tr>
                                <td width='1%' align='left'>$</td>
                                <td width='9%' align='right'><?php echo number_format($rows['net'], 2); ?></td>
                            </tr>
                        </table>
                    </font>
                </td>
                ...
                <td style="border: 1px solid black;" align="right" width="50%" bgcolor="#DDDDDD">
                    <font color="#0066CC">
                        <table width='100%' align='center'>
                            <tr>
                                <td width='1%' align='left'>$</td>
                                <td width='9%' align='right'><?php echo number_format($rows['gst'], 2); ?></td>
                            </tr>
                        </table>
                    </font>
                </td>
                ...
                <td style="border: 1px solid black;" align="right" width="50%" bgcolor="#DDDDDD">
                    <font color="#0099CC">
                        <table align='center' width='100%'>
                            <tr>
                                <td width='1%' align='left'>$</td>
                                <td align='right' width='9%'><?php echo number_format($rows['grand_total'], 2); ?></td>
                            </tr>
                        </table>
                    </font>
                </td>
            ...
            ?>
                <tr>
                    ...
                    <td id="<?php echo sprintf('inline-answer-%s', $field->getId()); ?>">
                        ...
                        ?>
                            <a class="inline-edit" data-placement="bottom" data-toggle="tooltip" title="<?php echo $title; ?>" href="<?php echo $href; ?>">
                                <?php
                                if ($isFile && !$isEmpty) {
                                ...
                                $hint = ($field->isRequiredForClose() && $a && !$a->getValue() && get_class($field) != 'BooleanField') ?
                                    sprintf(
                                        '<i class="icon-warning-sign help-tip warning field-label" data-title="%s" data-content="%s"
                        /></i>',
                                        __('Required to close ticket'),
...
<ul class="tabs clean threads" id="ticket_tabs">
    ...
    <li><a id="ticket-tasks-tab" href="#tasks" data-url="<?php
    ...
    if ((count($children) != 0 || $ticket->isChild())) { ?>
        <li><a href="#relations" id="ticket-relations-tab" data-url="<?php
                                                                        echo sprintf('#tickets/%d/relations', $ticket->getId()); ?>"><?php echo __('Related Tickets');
                                                                                                                                        if (count($children)) {
        ...
        <div class="sticky bar stop actions" id="response_options">
            <ul class="tabs" id="response-tabs">
                ...
                if ($role->hasPerm(Ticket::PERM_REPLY) && !($blockReply)) { ?>
                    <li class="active <?php
                                        echo isset($errors['reply']) ? 'error' : ''; ?>"><a href="#reply" id="post-reply-tab"><?php echo __('Post Reply'); ?></a></li>
                <?php
                }
                if (!($blockReply)) { ?>
                    <li><a href="#note" <?php
                                        echo isset($errors['postnote']) ? 'class="error"' : ''; ?> id="post-note-tab"><?php echo __('Post Internal Note'); ?></a></li>
                <?php
                }
                ?>
            ...
            ?>
                <form id="reply" class="tab_content spellcheck exclusive save" data-lock-object-id="ticket/<?php echo $ticket->getId(); ?>" data-lock-id="<?php echo $mylock ? $mylock->getId() : ''; ?>" action="tickets.php?id=<?php
                                                                                                                                                                                                                                    echo $ticket->getId(); ?>#reply" name="reply" method="post" enctype="multipart/form-data" style="display:block">
                    <?php csrf_token(); ?>
                    ...
                    <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
                        <tbody id="to_sec">
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <select id="emailreply" name="emailreply" style="width:40%;">
                        ...
                        <tbody id="resp_sec">
                            ...
                            <tr>
                                ...
                                <br />
                                <textarea name="response" id="response" cols="50" data-signature-field="signature" data-dept-id="<?php echo $dept->getId(); ?>" data-signature="<?php
                                                                                                                                                                                echo Format::htmlchars(Format::viewableImages($signature)); ?>" placeholder="<?php echo __(
                                                                                                                                                                                                                                                                    'Start writing your response here. Use canned responses from the drop-down above'
                                                                                                                                                                                                                                                                ); ?>" rows="9" wrap="soft" class="<?php if ($cfg->isRichTextEnabled()) {
                                                                                                                                                                                                                                                                                                        echo 'richtext';
                                                                                                                                                                                                                                                                                                    }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($thisstaff->getSignature()) { ?>
                                        <label><input type="radio" name="signature" value="mine" <?php echo ($info['signature'] == 'mine') ? 'checked="checked"' : ''; ?>> <?php echo __('My Signature'); ?></label>
                                    <?php
                                    } ?>
                                    <?php
                                    if ($dept && $dept->canAppendSignature()) { ?>
                                        <label><input type="radio" name="signature" value="dept" <?php echo ($info['signature'] == 'dept') ? 'checked="checked"' : ''; ?>>
            ...
            if (!($blockReply)) {
            ?>
                <form id="note" class="hidden tab_content spellcheck exclusive save" data-lock-object-id="ticket/<?php echo $ticket->getId(); ?>" data-lock-id="<?php echo $mylock ? $mylock->getId() : ''; ?>" action="tickets.php?id=<?php echo $ticket->getId(); ?>#note" name="note" method="post" enctype="multipart/form-data">
                    <?php csrf_token(); ?>
                    <input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <textarea name="note" id="internal_note" cols="80" placeholder="<?php echo __('Note details'); ?>" rows="9" wrap="soft" class="<?php if ($cfg->isRichTextEnabled()) {
                                                                                                                                                                    echo 'richtext';
                                                                                                                                                                }
            ...
            <form id="transfer" class="tab_content spellcheck exclusive save" data-lock-object-id="ticket/<?php echo $ticket->getId(); ?>" data-lock-id="<?php echo $mylock ? $mylock->getId() : ''; ?>" action="tickets.php?id=<?php echo $ticket->getId(); ?>#transfer" name="transfer" method="post" enctype="multipart/form-data">
                <?php csrf_token(); ?>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="transfer_comments" id="transfer_comments" placeholder="<?php echo __('Enter reasons for the transfer'); ?>" class="richtext ifhtml no-bar" cols="80" rows="7" wrap="soft"><?php
            ...
            <form id="assign" class="tab_content spellcheck exclusive save" data-lock-object-id="ticket/<?php echo $ticket->getId(); ?>" data-lock-id="<?php echo $mylock ? $mylock->getId() : ''; ?>" action="tickets.php?id=<?php echo $ticket->getId(); ?>#assign" name="assign" method="post" enctype="multipart/form-data">
                <?php csrf_token(); ?>
                <input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">
                ...
                <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
                        ...
                        <td>
                            ...
                            if ($ticket->isAssigned() && $ticket->isOpen()) { ?>
                                <div class="faded"><?php echo sprintf(
                                                        __('Ticket is currently assigned to %s'),
                                                        sprintf('<b>%s</b>', $ticket->getAssignee())
                                                    ); ?></div> <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="assign_comments" id="assign_comments" cols="80" rows="7" wrap="soft" placeholder="<?php echo __('Enter reasons for the assignment or instructions for assignee'); ?>" class="richtext ifhtml no-bar"><?php echo $info['assign_comments']; ?></textarea>
                ...
                <tbody>
                        <tr>
                            <div class="grid-container">
                                ...
                                <div class="item2">
                                    <canvas id="signatureCanvas" width="500" height="50"></canvas>
                                    <div style="margin-left:30px;">
                                        <button id="clearButton">Clear</button>
                                    </div>
                                </div>
                                <div class="item3">Name:</div>
                                <div class="item4"><input type="name" id="signature_name" name="signature_name" placeholder="<?php echo __('Enter your name...'); ?>" data-draft-namespace="ticket.signature" data-draft-object-id="<?php echo $ticket->getId(); ?>" style="height:25px;width:100%;"><?php echo $info['signatureName']; ?></div>
                                <div class="item5" style="justify-content: end;">Date/Time:</div>
                                <div class="item6"><input type="date" id="signature_date" name="signature_date" placeholder="<?php echo __('Note details'); ?>" rows="9" wrap="soft" data-draft-namespace="ticket.note" data-draft-object-id="<?php echo $ticket->getId(); ?>" style="height:25px;width:100%;"><?php echo $info['signatureDate']; ?></div>
                                <div class="item7">I confirm that the engineer from Integra Corporation Pty Ltd has attended site as per the address detailed above.
                                    The engineer has completed the work and/or resolved the fault and/or delivered the products as services
                                    details in this job ticket. We are satisfied that the ticket has been completed and agree to pay the fees and
                                    charges associated with this ticket.
                                </div>
                            </div>
                            <script>
        ...
        <div style="display:none;" class="dialog" id="confirm-action">
            ...
            <p class="confirm-action" style="display:none;" id="changeuser-confirm">
                <span id="msg_warning" style="display:block;vertical-align:top">
                    <?php echo sprintf(
                        Format::htmlchars(__('%s <%s> will no longer have access to the ticket')),
                        '<b>' . Format::htmlchars($ticket->getName()) . '</b>',
                        Format::htmlchars($ticket->getEmail())
                    ); ?>
                </span>
                <?php echo sprintf(
                    __('Are you sure you want to <b>change</b> ticket owner to %s?'),
