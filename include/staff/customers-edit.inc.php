      ...
      <td width="75%">
        <table class="form_table" style="width:100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <td>
                <select name="custom_status" style="width: 166px;" id="custom_status"
                  ...
                  <option value="active" class="greenText"
                    <?php echo $info['custom_status'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                  <option value="closed" class="redText"
              ...
              <td>
                <select name="custom_type" id="custom_type" style="width: 166px;">
                  ...
                  <option value="residential"
                    <?php echo $info['custom_type'] == 'residential' ? "selected=\"selected\"" : ""; ?>>Residential
                  </option>
                  <option value="government"
                    <?php echo $info['custom_type'] == 'government' ? "selected=\"selected\"" : ""; ?>>Government
                  </option>
                  <option value="integra_media"
                    <?php echo $info['custom_type'] == 'integra_media' ? "selected=\"selected\"" : ""; ?>>Integra Media
                  </option>
                  <option value="positive_business_online"
                    <?php echo $info['custom_type'] == 'positive_business_online' ? "selected=\"selected\"" : ""; ?>>
          ...
          <tr>
            ...
            <td>
              ...
              <input type="radio" name="reggst" value="2"
                <?php echo $info['reggst'] == '2' ? "checked=\"checked\"" : ""; ?> />
              No
            </td>
          </tr>
          <tr>
          ...
          <tbody>
            ...
            <tr>
              <td>
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="businesstype" value="9"
            ...
            <tr>
              <td>&nbsp;&nbsp;&nbsp;
                <input type="radio" name="businesstype" value="17"
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                Postcode: <input type="text" size="5" name="postcode" id="postcode"
                  value="<?php echo $info['postcode']; ?>">
                &nbsp;
              </td>
            </tr>
            <tr>
      ...
      <div id="cust_auth_table">
        ...
        <table cellspacing="10px" width="100%" border="0" id="tb_internet" style="display:table;" class="custtable">
          ...
          <tr>
            ...
            <td align='left'>
              <select name="upstream_provider1" id="upstream_provider1" style='width:100%;'
                ...
                <?php while ($uppinfo1 = db_fetch_array($res4)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider1'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
            <td align='left'>
              <select name="upstream_provider2" id="upstream_provider2" style='width:100%;'
                onchange="getUpstreamProvider(2, 1);">
                <option value="">&lt;Select&gt;</option>
                <?php while ($uppinfo2 = db_fetch_array($res5)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider2'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
            <td align='left'>
              <select name="upstream_provider3" id="upstream_provider3" style='width:100%;'
                onchange="getUpstreamProvider(3,1);">
                <option value="">&lt;Select&gt;</option>
                <?php while ($uppinfo3 = db_fetch_array($res6)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider3'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
            <td align='left'>
              <select name="upstream_provider4" id="upstream_provider4" style='width:100%;'
                onchange="getUpstreamProvider(4,1);">
                <option value="">&lt;Select&gt;</option>
                <?php while ($uppinfo4 = db_fetch_array($res18)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider4'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
            <td align='left'>
              <select name="upstream_provider5" id="upstream_provider5" style='width:100%;'
                onchange="getUpstreamProvider(5,1);">
                <option value="">&lt;Select&gt;</option>
            ...
            <td align='left'>
              <select name="upstream_provider6" id="upstream_provider6" style='width:100%;'
                onchange="getUpstreamProvider(6,1);">
                <option value="">&lt;Select&gt;</option>
                <?php while ($uppinfo6 = db_fetch_array($res20)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider6'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
            <td align='left'>
              <select name="upstream_provider7" id="upstream_provider7" style='width:100%;'
                onchange="getUpstreamProvider(7,1);">
                <option value="">&lt;Select&gt;</option>
                <?php while ($uppinfo7 = db_fetch_array($res21)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider7'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
          ...
          <tr>
            ...
            <td><select name="service_type1" id="service_type1" width='100%' style='width:100%;'
                ...
                <option value="adsl1" <?php echo $info['service_type1'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type1'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type1'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type1'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type1'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type1'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type1'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type1'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type1'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="satellite"
                  <?php echo $info['service_type1'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type1'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type1'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type1'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type1'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
            ...
            <td><select name="service_type2" id="service_type2" width='100%' style='width:100%;'
                onchange="getServiceType(2,1)">
                <option value="">&lt;Select&gt;</option>
                <option value="adsl1" <?php echo $info['service_type2'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type2'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type2'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type2'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type2'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type2'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type2'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type2'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type2'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="shdsl" <?php echo $info['service_type2'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
                  SHDSL</option>
                <option value="satellite"
                  <?php echo $info['service_type2'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type2'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type2'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type2'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type2'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
            ...
            <td><select name="service_type3" id="service_type3" width='100%' style='width:100%;'
                onchange="getServiceType(3,1)">
                <option value="">&lt;Select&gt;</option>
                <option value="adsl1" <?php echo $info['service_type3'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type3'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type3'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type3'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type3'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type3'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type3'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type3'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type3'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="shdsl" <?php echo $info['service_type3'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
                  SHDSL</option>
                <option value="satellite"
                  <?php echo $info['service_type3'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type3'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type3'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type3'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type3'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
            ...
            <td><select name="service_type4" id="service_type4" width='100%' style='width:100%;'
                onchange="getServiceType(4,1)">
                <option value="">&lt;Select&gt;</option>
                <option value="adsl1" <?php echo $info['service_type4'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type4'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type4'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type4'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type4'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type4'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type4'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type4'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type4'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="shdsl" <?php echo $info['service_type4'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
                  SHDSL</option>
                <option value="satellite"
                  <?php echo $info['service_type4'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type4'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type4'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type4'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type4'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
            ...
            <td><select name="service_type5" id="service_type5" width='100%' style='width:100%;'
                onchange="getServiceType(5,1)">
                <option value="">&lt;Select&gt;</option>
                <option value="adsl1" <?php echo $info['service_type5'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type5'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type5'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type5'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type5'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type5'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type5'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type5'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type5'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="shdsl" <?php echo $info['service_type5'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
                  SHDSL</option>
                <option value="satellite"
                  <?php echo $info['service_type5'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type5'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type5'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type5'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type5'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
            ...
            <td><select name="service_type6" id="service_type6" width='100%' style='width:100%;'
                onchange="getServiceType(6,1)">
                <option value="">&lt;Select&gt;</option>
                <option value="adsl1" <?php echo $info['service_type6'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type6'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type6'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type6'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type6'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type6'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type6'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type6'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type6'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="shdsl" <?php echo $info['service_type6'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
                  SHDSL</option>
                <option value="satellite"
                  <?php echo $info['service_type6'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type6'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type6'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type6'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type6'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
            ...
            <td><select name="service_type7" id="service_type7" width='100%' style='width:100%;'
                onchange="getServiceType(7,1)">
                <option value="">&lt;Select&gt;</option>
                <option value="adsl1" <?php echo $info['service_type7'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ADSL
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type7'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>
                  ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type7'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                  <?php echo $info['service_type7'] == 'wireless_bmb' ? "selected=\"selected\"" : ""; ?>>Wireless / BMB
                </option>
                <option value="wireless_gateway"
                  <?php echo $info['service_type7'] == 'wireless_gateway' ? "selected=\"selected\"" : ""; ?>>Wireless /
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type7'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type7'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type7'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>
                  EFM / 8 Wire
                </option>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type7'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>
                  Naked ADSL
                </option>
                ...
                <option value="shdsl" <?php echo $info['service_type7'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
                  SHDSL</option>
                <option value="satellite"
                  <?php echo $info['service_type7'] == 'satellite' ? "selected=\"selected\"" : ""; ?>>
                  Satellite</option>
                <option value="fofw" <?php echo $info['service_type7'] == 'fofw' ? "selected=\"selected\"" : ""; ?>>FoFW
                </option>
                <option value="wireless_3g"
                  <?php echo $info['service_type7'] == 'wireless_3g' ? "selected=\"selected\"" : ""; ?>>Wireless / 3G
                </option>
                <option value="wireless_4g"
                  <?php echo $info['service_type7'] == 'wireless_4g' ? "selected=\"selected\"" : ""; ?>>Wireless / 4G
                </option>
                <option value="wireless_5g"
                  <?php echo $info['service_type7'] == 'wireless_5g' ? "selected=\"selected\"" : ""; ?>>Wireless / 5G
                </option>
          ...
          <tr>
            ...
            <td><select name="service_use1" id="service_use1" width='100%' style='width:100%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use1'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use1'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use1'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use1'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use1'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use1'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
            ...
            <td><select name="service_use2" id="service_use2" width='100%' style='width:100%;'
                onchange="getServiceUse(2, 1)">
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use2'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use2'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use2'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use2'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use2'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use2'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
            ...
            <td><select name="service_use3" id="service_use3" width='100%' style='width:100%;'
                onchange="getServiceUse(3, 1)">
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use3'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use3'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use3'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use3'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use3'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use3'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
                <option value="other" <?php echo $info['service_use3'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td><select name="service_use4" id="service_use4" width='100%' style='width:100%;'
                onchange="getServiceUse(4, 1)">
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use4'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use4'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use4'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use4'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use4'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use4'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
                <option value="other" <?php echo $info['service_use4'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td><select name="service_use5" id="service_use5" width='100%' style='width:100%;'
                onchange="getServiceUse(5, 1)">
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use5'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use5'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use5'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use5'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use5'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use5'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
                <option value="other" <?php echo $info['service_use5'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td><select name="service_use6" id="service_use6" width='100%' style='width:100%;'
                onchange="getServiceUse(6, 1)">
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use6'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use6'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use6'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use6'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use6'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use6'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
                <option value="other" <?php echo $info['service_use6'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td><select name="service_use7" id="service_use7" width='100%' style='width:100%;'
                onchange="getServiceUse(7, 1)">
                <option value="">&lt;Select&gt;</option>
                <option value="voice_phones"
                  <?php echo $info['service_use7'] == 'voice_phones' ? "selected=\"selected\"" : ""; ?>>Voice</option>
                <option value="data_office"
                  <?php echo $info['service_use7'] == 'data_office' ? "selected=\"selected\"" : ""; ?>>Data</option>
                <option value="shared" <?php echo $info['service_use7'] == 'shared' ? "selected=\"selected\"" : ""; ?>>
                  Shared</option>
                <option value="data_vpn"
                  <?php echo $info['service_use7'] == 'data_vpn' ? "selected=\"selected\"" : ""; ?>>VPN
                </option>
                <option value="backup" <?php echo $info['service_use7'] == 'backup' ? "selected=\"selected\"" : ""; ?>>
                  Backup</option>
                <option value="failover"
                  <?php echo $info['service_use7'] == 'failover' ? "selected=\"selected\"" : ""; ?>>
                  Failover</option>
          ...
          <tr>
            ...
            <td><input name="ip_address2" id="ip_address2" type="text"
                style='width:97%; padding:0px;height:23px;padding-left:4px;padding-left:4px;border-radius:13px;'
                value="<?php echo $info['ip_address2']; ?>" onchange="interact(2, 1)"></td>
            <td><input name="ip_address3" id="ip_address3" type="text"
                style='width:97%; padding:0px;height:23px;padding-left:4px;padding-left:4px;border-radius:13px;'
                value="<?php echo $info['ip_address3']; ?>" onchange="interact(3, 1)"></td>
            <td><input name="ip_address4" id="ip_address4" type="text"
                style='width:97%; padding:0px;height:23px;padding-left:4px;padding-left:4px;border-radius:13px;'
                value="<?php echo $info['ip_address4']; ?>" onchange="interact(4, 1)"></td>
            <td><input name="ip_address5" id="ip_address5" type="text"
                style='width:97%; padding:0px;height:23px;padding-left:4px;padding-left:4px;border-radius:13px;'
                value="<?php echo $info['ip_address5']; ?>" onchange="interact(5, 1)"></td>
            <td><input name="ip_address6" id="ip_address6" type="text"
                style='width:97%; padding:0px;height:23px;padding-left:4px;padding-left:4px;border-radius:13px;'
                value="<?php echo $info['ip_address6']; ?>" onchange="interact(6, 1)"></td>
            <td><input name="ip_address7" id="ip_address7" type="text"
                style='width:97%; padding:0px;height:23px;padding-left:4px;padding-left:4px;border-radius:13px;'
        ...
        <table cellspacing="10px" width="100%" border="0" id="details1" style="display:none;"
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service1" id="service1" width='80%' style='width:80%;'
                ...
                <option class="orangeText" value="pending"
                  <?php echo $info['service1'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service1'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address1" id="public_ip1" type="text" style='width:80%;'
                value="<?php echo $info['ip_address1']; ?>" onchange="interact(1, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="auth_password1" id="auth_password1" type="text" style='width:80%;'
                value="<?php echo $info['auth_password1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route1" id="primary_route1" type="text" style='width:80%;'
                value="<?php echo $info['primary_route1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status1" id="service_status1" type="text" style='width:67%;'
                value="<?php echo $info['service_status1']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username1" id="auth_username1" type="text"
                style='width:128%; margin-left:-48%' value="<?php echo $info['auth_username1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type1" id="device_type1" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type1'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand1" id="hardware_brand1" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type1" id="service2_type1" style='width:81%;' onchange="getServiceType(1,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type1'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type1'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type1'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type1'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type1'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type1'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type1'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type1'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type1'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type1'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type1'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model1" id="hardware_model1" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier1" id="internet_underlining_carrier1" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier1'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier1'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier1'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier1'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier1'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier1'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip1" id="hardware_device_ip1" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username1" id="device_username1" type="text" style='width:80%;'
                value="<?php echo $info['device_username1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password1" id="device_password1" type="text" style='width:80%;'
                value="<?php echo $info['device_password1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled1" id="wireless_enabled1" width='80%' style='width:80%;'
                ...
                <option value="active"
                  <?php echo $info['wireless_enabled1'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd1" id="wireless_ssd1" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password1" id="wireless_password1" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_comments1" id="wireless_comments1" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments1']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date1" id="order_date1" type="date" style='width:32%;'
                value="<?php echo $info['order_date1']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date1" id="activation_date1" type="date" style='width:32%;'
                value="<?php echo $info['activation_date1']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date1" id="cancellation_date1" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date1']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="details2" style="display:none;"
          class="service_details custtable">
          <tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service2" id="service2" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['service2'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service2'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address2" id="public_ip2" type="text" style='width:80%;'
                value="<?php echo $info['ip_address2']; ?>" onchange="interact(2, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="auth_password2" id="auth_password2" type="text" style='width:80%;'
                value="<?php echo $info['auth_password2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route2" id="primary_route2" type="text" style='width:80%;'
                value="<?php echo $info['primary_route2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status2" id="service_status2" type="text" style='width:67%;'
                value="<?php echo $info['service_status2']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username2" id="auth_username2" type="text"
                style='width:128%; margin-left:-48%;' value="<?php echo $info['auth_username2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type2" id="device_type2" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type2'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand2" id="hardware_brand2" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type2" id="service2_type2" style='width:81%;' onchange="getServiceType(2,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type2'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type2'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type2'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type2'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type2'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type2'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type2'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type2'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type2'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type2'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type2'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model2" id="hardware_model2" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier2" id="internet_underlining_carrier2" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier2'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier2'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier2'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier2'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier2'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier2'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip2" id="hardware_device_ip2" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username2" id="device_username2" type="text" style='width:80%;'
                value="<?php echo $info['device_username2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password2" id="device_password2" type="text" style='width:80%;'
                value="<?php echo $info['device_password2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled2" id="wireless_enabled2" width='80%' style='width:80%;'
                ...
                <option value="">No</option>
                <option value="active"
                  <?php echo $info['wireless_enabled2'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd2" id="wireless_ssd2" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password2" id="wireless_password2" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_comments2" id="wireless_comments2" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments2']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date2" id="order_date2" type="date" style='width:32%;'
                value="<?php echo $info['order_date2']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date2" id="activation_date2" type="date" style='width:32%;'
                value="<?php echo $info['activation_date2']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date2" id="cancellation_date2" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date2']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="details3" style="display:none;"
          class="service_details custtable">
          <tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service3" id="service3" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['service3'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service3'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address3" id="public_ip3" type="text" style='width:80%;'
                value="<?php echo $info['ip_address3']; ?>" onchange="interact(3, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="auth_password3" id="auth_password3" type="text" style='width:80%;'
                value="<?php echo $info['auth_password3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route3" id="primary_route3" type="text" style='width:80%;'
                value="<?php echo $info['primary_route3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status3" id="service_status3" type="text" style='width:67%;'
                value="<?php echo $info['service_status3']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username3" id="auth_username3" type="text"
                style='width:128%; margin-left:-48%;' value="<?php echo $info['auth_username3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type3" id="device_type3" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type3'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand3" id="hardware_brand3" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type3" id="service2_type3" style='width:81%;' onchange="getServiceType(3,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type3'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type3'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type3'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type3'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type3'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type3'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type3'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type3'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type3'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type3'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type3'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model3" id="hardware_model3" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier3" id="internet_underlining_carrier3" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier3'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier3'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier3'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier3'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier3'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier3'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip3" id="hardware_device_ip3" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username3" id="device_username3" type="text" style='width:80%;'
                value="<?php echo $info['device_username3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password3" id="device_password3" type="text" style='width:80%;'
                value="<?php echo $info['device_password3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled3" id="wireless_enabled3" width='80%' style='width:80%;'
                ...
                <option value="">No</option>
                <option value="active"
                  <?php echo $info['wireless_enabled3'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd3" id="wireless_ssd3" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password3" id="wireless_password3" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_comments3" id="wireless_comments3" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments3']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date3" id="order_date3" type="date" style='width:32%;'
                value="<?php echo $info['order_date3']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date3" id="activation_date3" type="date" style='width:32%;'
                value="<?php echo $info['activation_date3']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date3" id="cancellation_date3" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date3']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="details4" style="display:none;"
          class="service_details custtable">
          <tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service4" id="service4" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['service4'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service4'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address4" id="public_ip4" type="text" style='width:80%;'
                value="<?php echo $info['ip_address4']; ?>" onchange="interact(4, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="auth_password4" id="auth_password4" type="text" style='width:80%;'
                value="<?php echo $info['auth_password4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route4" id="primary_route4" type="text" style='width:80%;'
                value="<?php echo $info['primary_route4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status4" id="service_status4" type="text" style='width:67%;'
                value="<?php echo $info['service_status4']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username4" id="auth_username4" type="text"
                style='width:128%; margin-left:-48%;' value="<?php echo $info['auth_username4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type4" id="device_type4" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type4'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand4" id="hardware_brand4" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type4" id="service2_type4" style='width:81%;' onchange="getServiceType(4,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type4'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type4'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type4'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type4'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type4'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type4'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type4'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type4'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type4'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type4'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type4'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model4" id="hardware_model4" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier4" id="internet_underlining_carrier4" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier4'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier4'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier4'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier4'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier4'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier4'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip4" id="hardware_device_ip4" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username4" id="device_username4" type="text" style='width:80%;'
                value="<?php echo $info['device_username4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password4" id="device_password4" type="text" style='width:80%;'
                value="<?php echo $info['device_password4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled4" id="wireless_enabled4" width='80%' style='width:80%;'
                ...
                <option value="">No</option>
                <option value="active"
                  <?php echo $info['wireless_enabled4'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd4" id="wireless_ssd4" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password4" id="wireless_password4" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="comments4" id="wireless_comments4" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments4']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date4" id="order_date4" type="date" style='width:32%;'
                value="<?php echo $info['order_date4']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date4" id="activation_date4" type="date" style='width:32%;'
                value="<?php echo $info['activation_date4']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date4" id="cancellation_date4" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date4']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="details5" style="display:none;"
          class="service_details custtable">
          <tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service5" id="service5" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['service5'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service5'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address5" id="public_ip5" type="text" style='width:80%;'
                value="<?php echo $info['ip_address5']; ?>" onchange="interact(5, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="upstream_provider5" id="upstream_provider_other5" style='width:80%;'
                ...
                <?php while ($uppinfo5 = db_fetch_array($res26)) {
                                ...
                                ?>
                <option value="other"
                  <?php echo $info['upstream_provider5'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select>
            </td>
            ...
            <td align='left'>
              <input name="auth_password5" id="auth_password5" type="text" style='width:80%;'
                value="<?php echo $info['auth_password5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route5" id="primary_route5" type="text" style='width:80%;'
                value="<?php echo $info['primary_route5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status5" id="service_status5" type="text" style='width:67%;'
                value="<?php echo $info['service_status5']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username5" id="auth_username5" type="text"
                style='width:128%; margin-left:-48%;' value="<?php echo $info['auth_username5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type5" id="device_type5" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type5'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand5" id="hardware_brand5" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type5" id="service2_type5" style='width:81%;' onchange="getServiceType(5,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type5'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type5'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type5'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type5'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type5'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type5'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type5'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type5'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type5'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type5'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type5'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model5" id="hardware_model5" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier5" id="internet_underlining_carrier5" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier5'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier5'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier5'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier5'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier5'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier5'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip5" id="hardware_device_ip5" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username5" id="device_username5" type="text" style='width:80%;'
                value="<?php echo $info['device_username5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password5" id="device_password5" type="text" style='width:80%;'
                value="<?php echo $info['device_password5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled5" id="wireless_enabled5" width='80%' style='width:80%;'
                ...
                <option value="">No</option>
                <option value="active"
                  <?php echo $info['wireless_enabled5'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd5" id="wireless_ssd5" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password5" id="wireless_password5" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_comments5" id="wireless_comments5" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments5']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date5" id="order_date5" type="date" style='width:32%;'
                value="<?php echo $info['order_date5']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date5" id="activation_date5" type="date" style='width:32%;'
                value="<?php echo $info['activation_date5']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date5" id="cancellation_date5" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date5']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="details6" style="display:none;"
          class="service_details custtable">
          <tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service6" id="service6" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['service6'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service6'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address6" id="public_ip6" type="text" style='width:80%;'
                value="<?php echo $info['ip_address6']; ?>" onchange="interact(6, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="auth_password6" id="auth_password6" type="text" style='width:80%;'
                value="<?php echo $info['auth_password6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route6" id="primary_route6" type="text" style='width:80%;'
                value="<?php echo $info['primary_route6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status6" id="service_status6" type="text" style='width:67%;'
                value="<?php echo $info['service_status6']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username6" id="auth_username6" type="text"
                style='width:128%; margin-left:-48%;' value="<?php echo $info['auth_username6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type6" id="device_type6" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type6'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand6" id="hardware_brand6" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type6" id="service2_type6" style='width:81%;' onchange="getServiceType(6,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type6'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type6'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type6'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type6'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type6'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type6'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type6'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type6'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type6'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type6'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type6'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model6" id="hardware_model6" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier6" id="internet_underlining_carrier6" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier6'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier6'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier6'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier6'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier6'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier6'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip6" id="hardware_device_ip6" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username6" id="device_username6" type="text" style='width:80%;'
                value="<?php echo $info['device_username6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password6" id="device_password6" type="text" style='width:80%;'
                value="<?php echo $info['device_password6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled6" id="wireless_enabled6" width='80%' style='width:80%;'
                ...
                <option value="">No</option>
                <option value="active"
                  <?php echo $info['wireless_enabled6'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd6" id="wireless_ssd6" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password6" id="wireless_password6" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_comments6" id="wireless_comments6" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments6']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date6" id="order_date6" type="date" style='width:35%;'
                value="<?php echo $info['order_date6']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date6" id="activation_date6" type="date" style='width:32%;'
                value="<?php echo $info['activation_date6']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date6" id="cancellation_date6" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date6']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="details7" style="display:none;"
          class="service_details custtable">
          <tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="service7" id="service7" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['service7'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['service7'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
            ...
            <td align='left'>
              <input name="ip_address7" id="public_ip7" type="text" style='width:80%;'
                value="<?php echo $info['ip_address7']; ?>" onchange="interact(7, 0)">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="auth_password7" id="auth_password7" type="text" style='width:80%;'
                value="<?php echo $info['auth_password7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="primary_route7" id="primary_route7" type="text" style='width:80%;'
                value="<?php echo $info['primary_route7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left' style="display:flex;">
              ...
              <input name="service_status7" id="service_status7" type="text" style='width:67%;'
                value="<?php echo $info['service_status7']; ?>">
            </td>
            ...
            <td align='left'>
              <input placeholder="User Name" name="auth_username7" id="auth_username7" type="text"
                style='width:128%; margin-left:-48%;' value="<?php echo $info['auth_username7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="device_type7" id="device_type7" width='80%' style='width:80%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['device_type7'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Router</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="hardware_brand7" id="hardware_brand7" type="text" style='width:80%;'
                value="<?php echo $info['hardware_brand7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="service_type7" id="service2_type7" style='width:81%;' onchange="getServiceType(7,0)">
                ...
                <option value="adsl1" <?php echo $info['service_type7'] == 'adsl1' ? "selected=\"selected\"" : ""; ?>>
                  ...
                  1</option>
                <option value="adsl2_plus"
                  <?php echo $info['service_type7'] == 'adsl2_plus' ? "selected=\"selected\"" : ""; ?>>ADSL 2+</option>
                <option value="adsl_exstream"
                  <?php echo $info['service_type7'] == 'adsl_exstream' ? "selected=\"selected\"" : ""; ?>>ADSL Exstream
                </option>
                <option value="wireless_bmb"
                ...
                <option value="wireless_gateway"
                  ...
                  Gateway</option>
                <option value="efm_4_wire"
                  <?php echo $info['service_type7'] == 'efm_4_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 4 Wire
                </option>
                <option value="efm_6_wire"
                  <?php echo $info['service_type7'] == 'efm_6_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 6 Wire
                </option>
                <option value="efm_8_wire"
                  <?php echo $info['service_type7'] == 'efm_8_wire' ? "selected=\"selected\"" : ""; ?>>EFM / 8 Wire
                </option>
                <option value="eofw" <?php echo $info['service_type7'] == 'eofw' ? "selected=\"selected\"" : ""; ?>>EoFW
                </option>
                <option value="fibre" <?php echo $info['service_type7'] == 'fibre' ? "selected=\"selected\"" : ""; ?>>
                ...
                <option value="naked_adsl"
                  <?php echo $info['service_type7'] == 'naked_adsl' ? "selected=\"selected\"" : ""; ?>>Naked ADSL
                </option>
                <option value="nbn" <?php echo $info['service_type7'] == 'nbn' ? "selected=\"selected\"" : ""; ?>>NBN
                </option>
                <option value="shdsl" <?php echo $info['service_type7'] == 'shdsl' ? "selected=\"selected\"" : ""; ?>>
            ...
            <td align='left'>
              <input name="hardware_model7" id="hardware_model7" type="text" style='width:80%;'
                value="<?php echo $info['hardware_model7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select name="internet_underlining_carrier7" id="internet_underlining_carrier7" style='width:81%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="optus"
                  <?php echo $info['internet_underlining_carrier7'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="telstra"
                  <?php echo $info['internet_underlining_carrier7'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>
                  Telstra</option>
                <option value="bigair"
                  <?php echo $info['internet_underlining_carrier7'] == 'bigair' ? "selected=\"selected\"" : ""; ?>>
                  Bigair
                </option>
                <option value="polyphone"
                  <?php echo $info['internet_underlining_carrier7'] == 'polyphone' ? "selected=\"selected\"" : ""; ?>>
                  Polyfone</option>
                <option value="tpg"
                  <?php echo $info['internet_underlining_carrier7'] == 'tpg' ? "selected=\"selected\"" : ""; ?>>TPG
                </option>
                <option value="other"
                  <?php echo $info['internet_underlining_carrier7'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select>
            </td>
            <td align='right'>
            ...
            <td align='left'>
              <input name="hardware_device_ip7" id="hardware_device_ip7" type="text" style='width:80%;'
                value="<?php echo $info['hardware_device_ip7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_username7" id="device_username7" type="text" style='width:80%;'
                value="<?php echo $info['device_username7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="device_password7" id="device_password7" type="text" style='width:80%;'
                value="<?php echo $info['device_password7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <select name="wireless_enabled7" id="wireless_enabled7" width='80%' style='width:80%;'
                ...
                <option value="">No</option>
                <option value="active"
                  <?php echo $info['wireless_enabled7'] == 'active' ? "selected=\"selected\"" : ""; ?>>
                  Yes</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_ssd7" id="wireless_ssd7" type="text" style='width:80%;'
                value="<?php echo $info['wireless_ssd7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_password7" id="wireless_password7" type="text" style='width:80%;'
                value="<?php echo $info['wireless_password7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="wireless_comments7" id="wireless_comments7" type="text" style='width:80%;'
                value="<?php echo $info['wireless_comments7']; ?>">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td align='left'>
              <input name="order_date7" id="order_date7" type="date" style='width:32%;'
                value="<?php echo $info['order_date7']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="activation_date7" id="activation_date7" type="date" style='width:32%;'
                value="<?php echo $info['activation_date7']; ?>">
              By
          ...
          <tr>
            ...
            <td align='left'>
              <input name="cancellation_date7" id="cancellation_date7" type="date" style='width:32%;'
                value="<?php echo $info['cancellation_date7']; ?>">
              By
        ...
        <table cellspacing="10px" width="100%" border="0" id="tb_sip" style="display:none;" class="custtable">
          ...
          <tr>
            ...
            <td><input name="sip_number1" id="sip_number1" type="text" style='width:90%;'
                value="<?php echo $info['sip_number1']; ?>"></td>
            <td><input name="sip_number2" id="sip_number2" type="text" style='width:90%;'
                value="<?php echo $info['sip_number2']; ?>"></td>
            <td><input name="sip_number3" id="sip_number3" type="text" style='width:90%;'
                value="<?php echo $info['sip_number3']; ?>"></td>
          </tr>
          <tr>
            <td><b>SIP Use</b></td>
          ...
          <tr>
            <td><b>Other</b></td>
            <td><input name="sip_use_other1" id="sip_use_other1" type="text" style='width:90%;'
                value="<?php echo $info['sip_use_other1']; ?>"></td>
            <td><input name="sip_use_other2" id="sip_use_other2" type="text" style='width:90%;'
                value="<?php echo $info['sip_use_other2']; ?>"></td>
            <td><input name="sip_use_other3" id="sip_use_other3" type="text" style='width:90%;'
                value="<?php echo $info['sip_use_other3']; ?>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="sip_connect1" id="sip_connect1" width='100%' style='width:92%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="ip_pb_onpremise"
                  <?php echo $info['sip_connect1'] == 'ip_pb_onpremise' ? "selected=\"selected\"" : ""; ?>>Hardware -
                  IP/PBX - On Premise</option>
                <option value="ip_pb_host"
                  <?php echo $info['sip_connect1'] == 'ip_pb_host' ? "selected=\"selected\"" : ""; ?>>Hardware - IP/PBX
                  -
                  Hosted</option>
                <option value="sip_handset"
                  <?php echo $info['sip_connect1'] == 'sip_handset' ? "selected=\"selected\"" : ""; ?>>Hardware - SIP
                  Handset</option>
                <option value="conf_handset"
                  <?php echo $info['sip_connect1'] == 'conf_handset' ? "selected=\"selected\"" : ""; ?>>Hardware -
                  Conference Handset</option>
                <option value="ata" <?php echo $info['sip_connect1'] == 'ata' ? "selected=\"selected\"" : ""; ?>>
                  Hardware
                  - ATA</option>
                <option value="cli_mobile"
                  <?php echo $info['sip_connect1'] == 'cli_mobile' ? "selected=\"selected\"" : ""; ?>>Soft Client -
                  Mobile
                </option>
                <option value="cli_tablet"
                  <?php echo $info['sip_connect1'] == 'cli_tablet' ? "selected=\"selected\"" : ""; ?>>Soft Client -
                  Tablet
                </option>
                <option value="cli_pc" <?php echo $info['sip_connect1'] == 'cli_pc' ? "selected=\"selected\"" : ""; ?>>
                  Soft Client - PC</option>
                <option value="cli_note"
                  <?php echo $info['sip_connect1'] == 'cli_note' ? "selected=\"selected\"" : ""; ?>>
                  Soft Client -
                  Notebook
                </option>
            ...
            <td><select name="sip_connect2" id="sip_connect2" width='100%' style='width:92%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="ip_pb_onpremise"
                  <?php echo $info['sip_connect2'] == 'ip_pb_onpremise' ? "selected=\"selected\"" : ""; ?>>Hardware -
                  IP/PBX - On Premise</option>
                <option value="ip_pb_host"
                  <?php echo $info['sip_connect2'] == 'ip_pb_host' ? "selected=\"selected\"" : ""; ?>>Hardware - IP/PBX
                  -
                  Hosted</option>
                <option value="sip_handset"
                  <?php echo $info['sip_connect2'] == 'sip_handset' ? "selected=\"selected\"" : ""; ?>>Hardware - SIP
                  Handset</option>
                <option value="conf_handset"
                  <?php echo $info['sip_connect2'] == 'conf_handset' ? "selected=\"selected\"" : ""; ?>>Hardware -
                  Conference Handset</option>
                <option value="ata" <?php echo $info['sip_connect2'] == 'ata' ? "selected=\"selected\"" : ""; ?>>
                  Hardware
                  - ATA</option>
                <option value="cli_mobile"
                  <?php echo $info['sip_connect2'] == 'cli_mobile' ? "selected=\"selected\"" : ""; ?>>Soft Client -
                  Mobile
                </option>
                <option value="cli_tablet"
                  <?php echo $info['sip_connect2'] == 'cli_tablet' ? "selected=\"selected\"" : ""; ?>>Soft Client -
                  Tablet
                </option>
                <option value="cli_pc" <?php echo $info['sip_connect2'] == 'cli_pc' ? "selected=\"selected\"" : ""; ?>>
                  Soft Client - PC</option>
                <option value="cli_note"
                  <?php echo $info['sip_connect2'] == 'cli_note' ? "selected=\"selected\"" : ""; ?>>
                  Soft Client -
                  Notebook
                </option>
            ...
            <td><select name="sip_connect3" id="sip_connect3" width='100%' style='width:92%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="ip_pb_onpremise"
                  <?php echo $info['sip_connect3'] == 'ip_pb_onpremise' ? "selected=\"selected\"" : ""; ?>>Hardware -
                  IP/PBX - On Premise</option>
                <option value="ip_pb_host"
                  <?php echo $info['sip_connect3'] == 'ip_pb_host' ? "selected=\"selected\"" : ""; ?>>Hardware - IP/PBX
                  -
                  Hosted</option>
                <option value="sip_handset"
                  <?php echo $info['sip_connect3'] == 'sip_handset' ? "selected=\"selected\"" : ""; ?>>Hardware - SIP
                  Handset</option>
                <option value="conf_handset"
                  <?php echo $info['sip_connect3'] == 'conf_handset' ? "selected=\"selected\"" : ""; ?>>Hardware -
                  Conference Handset</option>
                <option value="ata" <?php echo $info['sip_connect3'] == 'ata' ? "selected=\"selected\"" : ""; ?>>
                  Hardware
                  - ATA</option>
                <option value="cli_mobile"
                  <?php echo $info['sip_connect3'] == 'cli_mobile' ? "selected=\"selected\"" : ""; ?>>Soft Client -
                  Mobile
                </option>
                <option value="cli_tablet"
                  <?php echo $info['sip_connect3'] == 'cli_tablet' ? "selected=\"selected\"" : ""; ?>>Soft Client -
                  Tablet
                </option>
                <option value="cli_pc" <?php echo $info['sip_connect3'] == 'cli_pc' ? "selected=\"selected\"" : ""; ?>>
                  Soft Client - PC</option>
                <option value="cli_note"
                  <?php echo $info['sip_connect3'] == 'cli_note' ? "selected=\"selected\"" : ""; ?>>
                  Soft Client -
                  Notebook
                </option>
          ...
          <tr>
            <td><b>Other</b></td>
            <td><input name="sip_conn_other1" id="sip_conn_other1" type="text" style='width:90%;'
                value="<?php echo $info['sip_conn_other1']; ?>"></td>
            <td><input name="sip_conn_other2" id="sip_conn_other2" type="text" style='width:90%;'
                value="<?php echo $info['sip_conn_other2']; ?>"></td>
            <td><input name="sip_conn_other3" id="sip_conn_other3" type="text" style='width:90%;'
                value="<?php echo $info['sip_conn_other3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Brand</b></td>
            <td><input name="ip_pbx_brand1" id="ip_pbx_brand1" type="text" style='width:90%;'
                value="<?php echo $info['ip_pbx_brand1']; ?>"></td>
            <td><input name="ip_pbx_brand2" id="ip_pbx_brand2" type="text" style='width:90%;'
                value="<?php echo $info['ip_pbx_brand2']; ?>"></td>
            <td><input name="ip_pbx_brand3" id="ip_pbx_brand3" type="text" style='width:90%;'
                value="<?php echo $info['ip_pbx_brand3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Model</b></td>
            <td><input name="ip_pbx_model1" id="ip_pbx_model1" type="text" style='width:90%;'
                value="<?php echo $info['ip_pbx_model1']; ?>"></td>
            <td><input name="ip_pbx_model2" id="ip_pbx_model2" type="text" style='width:90%;'
                value="<?php echo $info['ip_pbx_model2']; ?>"></td>
            <td><input name="ip_pbx_model3" id="ip_pbx_model3" type="text" style='width:90%;'
                value="<?php echo $info['ip_pbx_model3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Serial Number</b></td>
            <td><input name="serial_number1" id="serial_number1" type="text" style='width:90%;'
                value="<?php echo $info['serial_number1']; ?>"></td>
            <td><input name="serial_number2" id="serial_number2" type="text" style='width:90%;'
                value="<?php echo $info['serial_number2']; ?>"></td>
            <td><input name="serial_number3" id="serial_number3" type="text" style='width:90%;'
                value="<?php echo $info['serial_number3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Unique ID</b></td>
            <td><input name="unique_id1" id="unique_id1" type="text" style='width:90%;'
                value="<?php echo $info['unique_id1']; ?>"></td>
            <td><input name="unique_id2" id="unique_id2" type="text" style='width:90%;'
                value="<?php echo $info['unique_id2']; ?>"></td>
            <td><input name="unique_id3" id="unique_id3" type="text" style='width:90%;'
                value="<?php echo $info['unique_id3']; ?>"></td>
          </tr>
          <tr>
            <td colspan="4">
              <hr />
        ...
        <table cellspacing="10px" width="100%" border="0" id="tb_fax" style="display:none;" class="custtable">
          ...
          <tr>
            ...
            <td><input name="fax_in_svc_no" id="fax_in_svc_no" type="text" style='width:90%;'
                value="<?php echo $info['fax_in_svc_no']; ?>"></td>
            <td align='left'><select name="fax_in_svc_status" id="fax_in_svc_status" width='100%' style='width:100%;'
                ...
                <option class="orangeText" value="pending"
                  <?php echo $info['fax_in_svc_status'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['fax_in_svc_status'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
                  <?php echo $info['fax_in_svc_status'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled
                </option>
              </select></td>
            <td align='left'><select name="fax_in_svc_type" id="fax_in_svc_type" width='100%' style='width:100%;'>
                ...
                <option value="thrteen_hund_eight"
                  <?php echo $info['fax_in_svc_type'] == 'thrteen_hund_eight' ? "selected=\"selected\"" : ""; ?>>
                  13/1300/1800</option>
              </select></td>
            <td align='left'><select name="fax_in_svc_provider" id="fax_in_svc_provider" width='100%'
                style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="aapt"
                  <?php echo $info['fax_in_svc_provider'] == 'aapt' ? "selected=\"selected\"" : ""; ?>>
                  AAPT</option>
                <option value="integra"
                  <?php echo $info['fax_in_svc_provider'] == 'integra' ? "selected=\"selected\"" : ""; ?>>Integra
                </option>
                <option value="isph"
                  <?php echo $info['fax_in_svc_provider'] == 'isph' ? "selected=\"selected\"" : ""; ?>>
                  Isphone</option>
                <option value="mnf" <?php echo $info['fax_in_svc_provider'] == 'mnf' ? "selected=\"selected\"" : ""; ?>>
                  MNF</option>
                <option value="optus"
                  <?php echo $info['fax_in_svc_provider'] == 'optus' ? "selected=\"selected\"" : ""; ?>>
                  Optus</option>
                <option value="symbio"
                  <?php echo $info['fax_in_svc_provider'] == 'symbio' ? "selected=\"selected\"" : ""; ?>>
                  Symbio</option>
                <option value="telstra"
                  <?php echo $info['fax_in_svc_provider'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>Telstra
                </option>
                <option value="viaip"
                  <?php echo $info['fax_in_svc_provider'] == 'viaip' ? "selected=\"selected\"" : ""; ?>>
                  Viaip</option>
                <option value="westnet"
                  <?php echo $info['fax_in_svc_provider'] == 'westnet' ? "selected=\"selected\"" : ""; ?>>Westnet
                </option>
                <option value="other"
                  <?php echo $info['fax_in_svc_provider'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select></td>
            <td><input name="fax_in_svc_id" id="fax_in_svc_id" type="text" style='width:90%;'
                value="<?php echo $info['fax_in_svc_id']; ?>"></td>
          </tr>
          <tr>
            <td><b>End Point Number1:</b></td>
            <td><input name="fax_in_epn1_svc_no" id="fax_in_epn1_svc_no" type="text" style='width:90%;'
                value="<?php echo $info['fax_in_epn1_svc_no']; ?>"></td>
            <td align='left'><select name="fax_in_epn1_svc_status" id="fax_in_epn1_svc_status" width='100%'
                style='width:100%;' onchange="this.className=this.options[this.selectedIndex].className">
                <option value="">&lt;Select&gt;</option>
                <option value="na"
                  <?php echo $info['fax_in_epn1_svc_status'] == 'na' ? "selected=\"selected\"" : ""; ?>>
                  N/A</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['fax_in_epn1_svc_status'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending
                </option>
                <option class="greenText" value="active"
                  <?php echo $info['fax_in_epn1_svc_status'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active
                </option>
                <option class="redText" value="cancelled"
                  <?php echo $info['fax_in_epn1_svc_status'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled
                </option>
              </select></td>
            <td align='left'><select name="fax_in_epn1_svc_type" id="fax_in_epn1_svc_type" width='100%'
                style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="thrteen_hund_eight"
                  <?php echo $info['fax_in_epn1_svc_type'] == 'thrteen_hund_eight' ? "selected=\"selected\"" : ""; ?>>
                  13/1300/1800</option>
                <option value="pstn"
                  <?php echo $info['fax_in_epn1_svc_type'] == 'pstn' ? "selected=\"selected\"" : ""; ?>>
                  PSTN</option>
                <option value="fax_two_email"
                  <?php echo $info['fax_in_epn1_svc_type'] == 'fax_two_email' ? "selected=\"selected\"" : ""; ?>>Fax 2
                  Email</option>
                <option value="sip"
                  <?php echo $info['fax_in_epn1_svc_type'] == 'sip' ? "selected=\"selected\"" : ""; ?>>
                  SIP</option>
              </select></td>
            <td align='left'><select name="fax_in_epn1_svc_provider" id="fax_in_epn1_svc_provider" width='100%'
                style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="aapt"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'aapt' ? "selected=\"selected\"" : ""; ?>>Aapt
                </option>
                <option value="integra"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'integra' ? "selected=\"selected\"" : ""; ?>>Integra
                </option>
                <option value="isph"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'isph' ? "selected=\"selected\"" : ""; ?>>Isphone
                </option>
                <option value="mnf"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'mnf' ? "selected=\"selected\"" : ""; ?>>
                  MNF</option>
                <option value="optus"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="symbio"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'symbio' ? "selected=\"selected\"" : ""; ?>>Symbio
                </option>
                <option value="telstra"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>Telstra
                </option>
                <option value="viaip"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'viaip' ? "selected=\"selected\"" : ""; ?>>Viaip
                </option>
                <option value="westnet"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'westnet' ? "selected=\"selected\"" : ""; ?>>Westnet
                </option>
                <option value="other"
                  <?php echo $info['fax_in_epn1_svc_provider'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select></td>
            <td><input name="fax_in_epn1_svc_id" id="fax_in_epn1_svc_id" type="text" style='width:90%;'
                value="<?php echo $info['fax_in_epn1_svc_id']; ?>"></td>
          </tr>
          <tr>
            <td><b>End Point Number2:</b></td>
            <td><input name="fax_in_epn2_svc_no" id="fax_in_epn2_svc_no" type="text" style='width:90%;'
                value="<?php echo $info['fax_in_epn2_svc_no']; ?>"></td>
            <td align='left'><select name="fax_in_epn2_svc_status" id="fax_in_epn2_svc_status" width='100%'
                style='width:100%;' onchange="this.className=this.options[this.selectedIndex].className">
                <option value="">&lt;Select&gt;</option>
                <option value="na"
                  <?php echo $info['fax_in_epn2_svc_status'] == 'na' ? "selected=\"selected\"" : ""; ?>>
                  N/A</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['fax_in_epn2_svc_status'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending
                </option>
                <option class="greenText" value="active"
                  <?php echo $info['fax_in_epn2_svc_status'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active
                </option>
                <option class="redText" value="cancelled"
                  <?php echo $info['fax_in_epn2_svc_status'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled
                </option>
              </select></td>
            <td align='left'><select name="fax_in_epn2_svc_type" id="fax_in_epn2_svc_type" width='100%'
                style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="thrteen_hund_eight"
                  <?php echo $info['fax_in_epn2_svc_type'] == 'thrteen_hund_eight' ? "selected=\"selected\"" : ""; ?>>
                  13/1300/1800</option>
                <option value="pstn"
                  <?php echo $info['fax_in_epn2_svc_type'] == 'pstn' ? "selected=\"selected\"" : ""; ?>>
                  PSTN</option>
                <option value="fax_two_email"
                  <?php echo $info['fax_in_epn2_svc_type'] == 'fax_two_email' ? "selected=\"selected\"" : ""; ?>>Fax 2
                  Email</option>
                <option value="sip"
                  <?php echo $info['fax_in_epn2_svc_type'] == 'sip' ? "selected=\"selected\"" : ""; ?>>
                  SIP</option>
              </select></td>
            <td align='left'><select name="fax_in_epn2_svc_provider" id="fax_in_epn2_svc_provider" width='100%'
                style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="aapt"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'aapt' ? "selected=\"selected\"" : ""; ?>>Aapt
                </option>
                <option value="integra"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'integra' ? "selected=\"selected\"" : ""; ?>>Integra
                </option>
                <option value="isph"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'isph' ? "selected=\"selected\"" : ""; ?>>Isphone
                </option>
                <option value="mnf"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'mnf' ? "selected=\"selected\"" : ""; ?>>
                  MNF</option>
                <option value="optus"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'optus' ? "selected=\"selected\"" : ""; ?>>Optus
                </option>
                <option value="symbio"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'symbio' ? "selected=\"selected\"" : ""; ?>>Symbio
                </option>
                <option value="telstra"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>Telstra
                </option>
                <option value="viaip"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'viaip' ? "selected=\"selected\"" : ""; ?>>Viaip
                </option>
                <option value="westnet"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'westnet' ? "selected=\"selected\"" : ""; ?>>Westnet
                </option>
                <option value="other"
                  <?php echo $info['fax_in_epn2_svc_provider'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select></td>
            <td><input name="fax_in_epn2_svc_id" id="fax_in_epn2_svc_id" type="text" style='width:90%;'
                value="<?php echo $info['fax_in_epn2_svc_id']; ?>"></td>
          </tr>
          <tr>
            <td><b>Email Address1:</b></td>
            <td colspan="2"><input name="fax_in_email1" id="fax_in_email1" type="text" style='width:100%;'
                value="<?php echo $info['fax_in_email1']; ?>"></td>
          </tr>
          <tr>
            <td><b>Email Address2:</b></td>
            <td colspan="2"><input name="fax_in_email2" id="fax_in_email2" type="text" style='width:100%;'
                value="<?php echo $info['fax_in_email2']; ?>"></td>
          </tr>
          <tr>
            <td><b>Email Address3:</b></td>
            <td colspan="2"><input name="fax_in_email3" id="fax_in_email3" type="text" style='width:100%;'
                value="<?php echo $info['fax_in_email3']; ?>"></td>
          </tr>
          ...
          <tr>
            ...
            <td><input name="fax_out_svc_no" id="fax_out_svc_no" type="text" style='width:90%;'
                value="<?php echo $info['fax_out_svc_no']; ?>"></td>
            <td align='left'><select name="fax_out_svc_status" id="fax_out_svc_status" width='100%' style='width:100%;'
                ...
                <option class="orangeText" value="pending"
                  <?php echo $info['fax_out_svc_status'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending
                </option>
                <option class="greenText" value="active"
                  <?php echo $info['fax_out_svc_status'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
                  <?php echo $info['fax_out_svc_status'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled
                </option>
              </select></td>
            <td align='left'><select name="fax_out_svc_type" id="fax_out_svc_type" width='100%' style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="thrteen_hund_eight"
                  <?php echo $info['fax_out_svc_type'] == 'thrteen_hund_eight' ? "selected=\"selected\"" : ""; ?>>
                  13/1300/1800</option>
                <option value="pstn" <?php echo $info['fax_out_svc_type'] == 'pstn' ? "selected=\"selected\"" : ""; ?>>
                  PSTN</option>
                <option value="fax_two_email"
                  <?php echo $info['fax_out_svc_type'] == 'fax_two_email' ? "selected=\"selected\"" : ""; ?>>Fax 2 Email
                </option>
                <option value="sip" <?php echo $info['fax_out_svc_type'] == 'sip' ? "selected=\"selected\"" : ""; ?>>SIP
                </option>
              </select></td>
            <td align='left'><select name="fax_out_svc_provider" id="fax_out_svc_provider" width='100%'
                style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="aapt"
                  <?php echo $info['fax_out_svc_provider'] == 'aapt' ? "selected=\"selected\"" : ""; ?>>
                  AAPT</option>
                <option value="integra"
                  <?php echo $info['fax_out_svc_provider'] == 'integra' ? "selected=\"selected\"" : ""; ?>>Integra
                </option>
                <option value="isph"
                  <?php echo $info['fax_out_svc_provider'] == 'isph' ? "selected=\"selected\"" : ""; ?>>
                  Isphone</option>
                <option value="mnf"
                  <?php echo $info['fax_out_svc_provider'] == 'mnf' ? "selected=\"selected\"" : ""; ?>>
                  MNF</option>
                <option value="optus"
                  <?php echo $info['fax_out_svc_provider'] == 'optus' ? "selected=\"selected\"" : ""; ?>>
                  Optus</option>
                <option value="symbio"
                  <?php echo $info['fax_out_svc_provider'] == 'symbio' ? "selected=\"selected\"" : ""; ?>>Symbio
                </option>
                <option value="telstra"
                  <?php echo $info['fax_out_svc_provider'] == 'telstra' ? "selected=\"selected\"" : ""; ?>>Telstra
                </option>
                <option value="viaip"
                  <?php echo $info['fax_out_svc_provider'] == 'viaip' ? "selected=\"selected\"" : ""; ?>>
                  Viaip</option>
                <option value="westnet"
                  <?php echo $info['fax_out_svc_provider'] == 'westnet' ? "selected=\"selected\"" : ""; ?>>Westnet
                </option>
                <option value="other"
                  <?php echo $info['fax_out_svc_provider'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;
                </option>
              </select></td>
            <td><input name="fax_out_svc_id" id="fax_out_svc_id" type="text" style='width:90%;'
                value="<?php echo $info['fax_out_svc_id']; ?>"></td>
          </tr>
          <tr>
            ...
            <td colspan="2"><input name="fax_out_svc_prd_other" id="fax_out_svc_prd_other" type="text"
                style='width:48%;' value="<?php echo $info['fax_out_svc_prd_other']; ?>"></td>
          </tr>
          <tr>
            <td><b>Brand:</b></td>
            <td colspan="2"><input name="fax_out_brand" id="fax_out_brand" type="text" style='width:100%;'
                value="<?php echo $info['fax_out_brand']; ?>"></td>
          </tr>
          <tr>
            <td><b>Model:</b></td>
            <td colspan="2"><input name="fax_out_model" id="fax_out_model" type="text" style='width:100%;'
                value="<?php echo $info['fax_out_model']; ?>"></td>
          </tr>
          <tr>
            <td><b>Device:</b></td>
            <td align='left' colspan="2"><select name="fax_out_device" id="fax_out_device" style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="fax_machine"
                  <?php echo $info['fax_out_device'] == 'fax_machine' ? "selected=\"selected\"" : ""; ?>>Fax Machine
                </option>
                <option value="small_mfc"
                  <?php echo $info['fax_out_device'] == 'small_mfc' ? "selected=\"selected\"" : ""; ?>>Small MFC
                </option>
                <option value="photo_copy_mfd"
                  <?php echo $info['fax_out_device'] == 'photo_copy_mfd' ? "selected=\"selected\"" : ""; ?>>Photo Copier
                  MFD</option>
                <option value="other" <?php echo $info['fax_out_device'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select></td>
            <td colspan="2"><input name="fax_out_device_other" id="fax_out_device_other" type="text" style='width:100%;'
                value="<?php echo $info['fax_out_device_other']; ?>"></td>
          </tr>
          <tr>
            <td><b>Interface:</b></td>
            <td align='left' colspan="2"><select name="fax_out_if" id="fax_out_if" style='width:100%;'>
                ...
                <option value="parallel"
                  <?php echo $info['fax_out_if'] == 'parallel' ? "selected=\"selected\"" : ""; ?>>
                  Parallel</option>
                ...
                <option value="ethernet"
                  <?php echo $info['fax_out_if'] == 'ethernet' ? "selected=\"selected\"" : ""; ?>>
                  Ethernet</option>
                <option value="other" <?php echo $info['fax_out_if'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select></td>
            <td colspan="2"><input name="fax_out_if_other" id="fax_out_if_other" type="text" style='width:100%;'
                value="<?php echo $info['fax_out_if_other']; ?>"></td>
          </tr>
          <tr>
            <td><b>Static IP Address:</b></td>
            <td colspan="2"><input name="fax_out_static_ip" id="fax_out_static_ip" type="text" style='width:100%;'
                value="<?php echo $info['fax_out_static_ip']; ?>"></td>
          </tr>
        </table>
        ...
        <table cellspacing="10px" width="100%" border="0" id="tb_inbound" style="display:none;" class="custtable">
          ...
          <tr>
            ...
            <td><select name="inb_svc_stat1" id="inb_svc_stat1" style='width:100%;'
                ...
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['inb_svc_stat1'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['inb_svc_stat1'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
                  <?php echo $info['inb_svc_stat1'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled</option>
              </select></td>
            <td><select name="inb_svc_stat2" id="inb_svc_stat2" style='width:100%;'
                onchange="this.className=this.options[this.selectedIndex].className">
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['inb_svc_stat2'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['inb_svc_stat2'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
                  <?php echo $info['inb_svc_stat2'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled</option>
              </select></td>
            <td><select name="inb_svc_stat3" id="inb_svc_stat3" style='width:100%;'
                onchange="this.className=this.options[this.selectedIndex].className">
                <option value="">&lt;Select&gt;</option>
                <option class="orangeText" value="pending"
                  <?php echo $info['inb_svc_stat3'] == 'pending' ? "selected=\"selected\"" : ""; ?>>Pending</option>
                <option class="greenText" value="active"
                  <?php echo $info['inb_svc_stat3'] == 'active' ? "selected=\"selected\"" : ""; ?>>Active</option>
                <option class="redText" value="cancelled"
                  <?php echo $info['inb_svc_stat3'] == 'cancelled' ? "selected=\"selected\"" : ""; ?>>Cancelled</option>
              </select></td>
          </tr>
          <tr>
            <td><b>Inbound Number : </b></td>
            <td><input name="inb_number1" id="inb_number1" type="text" style='width:90%;'
                value="<?php echo $info['inb_number1']; ?>"></td>
            <td><input name="inb_number2" id="inb_number2" type="text" style='width:90%;'
                value="<?php echo $info['inb_number2']; ?>"></td>
            <td><input name="inb_number3" id="inb_number3" type="text" style='width:90%;'
                value="<?php echo $info['inb_number3']; ?>"></td>
          </tr>
          <tr>
            <td><b>End Point Number(EP) : </b></td>
            <td><input name="inb_epn1" id="inb_epn1" type="text" style='width:90%;'
                value="<?php echo $info['inb_epn1']; ?>">
            </td>
            <td><input name="inb_epn2" id="inb_epn2" type="text" style='width:90%;'
                value="<?php echo $info['inb_epn2']; ?>">
            </td>
            <td><input name="inb_epn3" id="inb_epn3" type="text" style='width:90%;'
                value="<?php echo $info['inb_epn3']; ?>">
            </td>
          </tr>
          <tr>
            <td><b>Follow Me Number : </b></td>
            <td><input name="inb_fmn1" id="inb_fmn1" type="text" style='width:90%;'
                value="<?php echo $info['inb_fmn1']; ?>">
            </td>
            <td><input name="inb_fmn2" id="inb_fmn2" type="text" style='width:90%;'
                value="<?php echo $info['inb_fmn2']; ?>">
            </td>
            <td><input name="inb_fmn3" id="inb_fmn3" type="text" style='width:90%;'
                value="<?php echo $info['inb_fmn3']; ?>">
            </td>
          </tr>
          <tr>
            <td><b>Service Type : </b></td>
            <td><select name="inb_svc_type1" id="inb_svc_type1" style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="thir_tel"
                  <?php echo $info['inb_svc_type1'] == 'thir_tel' ? "selected=\"selected\"" : ""; ?>>
                  13-Inbound-Tel
                </option>
                <option value="thir_fax"
                  <?php echo $info['inb_svc_type1'] == 'thir_fax' ? "selected=\"selected\"" : ""; ?>>
                  13-Inbound-Fax
                </option>
                <option value="thir_hu_tel"
                  <?php echo $info['inb_svc_type1'] == 'thir_hu_tel' ? "selected=\"selected\"" : ""; ?>>1300-Inbound-Tel
                </option>
                <option value="thir_hu_fax"
                  <?php echo $info['inb_svc_type1'] == 'thir_hu_fax' ? "selected=\"selected\"" : ""; ?>>1300-Inbound-Fax
                </option>
                <option value="eight_hu_tel"
                  <?php echo $info['inb_svc_type1'] == 'eight_hu_tel' ? "selected=\"selected\"" : ""; ?>>
                  1800-Inbound-Tel
                </option>
                <option value="eight_hu_fax"
                  <?php echo $info['inb_svc_type1'] == 'eight_hu_fax' ? "selected=\"selected\"" : ""; ?>>
                  1800-Inbound-Fax
                </option>
              </select></td>
            <td><select name="inb_svc_type2" id="inb_svc_type2" style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="thir_tel"
                  <?php echo $info['inb_svc_type2'] == 'thir_tel' ? "selected=\"selected\"" : ""; ?>>
                  13-Inbound-Tel
                </option>
                <option value="thir_fax"
                  <?php echo $info['inb_svc_type2'] == 'thir_fax' ? "selected=\"selected\"" : ""; ?>>
                  13-Inbound-Fax
                </option>
                <option value="thir_hu_tel"
                  <?php echo $info['inb_svc_type2'] == 'thir_hu_tel' ? "selected=\"selected\"" : ""; ?>>1300-Inbound-Tel
                </option>
                <option value="thir_hu_fax"
                  <?php echo $info['inb_svc_type2'] == 'thir_hu_fax' ? "selected=\"selected\"" : ""; ?>>1300-Inbound-Fax
                </option>
                <option value="eight_hu_tel"
                  <?php echo $info['inb_svc_type2'] == 'eight_hu_tel' ? "selected=\"selected\"" : ""; ?>>
                  1800-Inbound-Tel
                </option>
                <option value="eight_hu_fax"
                  <?php echo $info['inb_svc_type2'] == 'eight_hu_fax' ? "selected=\"selected\"" : ""; ?>>
                  1800-Inbound-Fax
                </option>
              </select></td>
            <td><select name="inb_svc_type3" id="inb_svc_type3" style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="thir_tel"
                  <?php echo $info['inb_svc_type3'] == 'thir_tel' ? "selected=\"selected\"" : ""; ?>>
                  13-Inbound-Tel
                </option>
                <option value="thir_fax"
                  <?php echo $info['inb_svc_type3'] == 'thir_fax' ? "selected=\"selected\"" : ""; ?>>
                  13-Inbound-Fax
                </option>
                <option value="thir_hu_tel"
                  <?php echo $info['inb_svc_type3'] == 'thir_hu_tel' ? "selected=\"selected\"" : ""; ?>>1300-Inbound-Tel
                </option>
                <option value="thir_hu_fax"
                  <?php echo $info['inb_svc_type3'] == 'thir_hu_fax' ? "selected=\"selected\"" : ""; ?>>1300-Inbound-Fax
                </option>
                <option value="eight_hu_tel"
                  <?php echo $info['inb_svc_type3'] == 'eight_hu_tel' ? "selected=\"selected\"" : ""; ?>>
                  1800-Inbound-Tel
                </option>
                <option value="eight_hu_fax"
                  <?php echo $info['inb_svc_type3'] == 'eight_hu_fax' ? "selected=\"selected\"" : ""; ?>>
                  1800-Inbound-Fax
                </option>
              </select></td>
          </tr>
          <tr>
            <td><b>Upstream Provider : </b></td>
            <td><input name="inb_up_provider1" id="inb_up_provider1" type="text" style='width:90%;'
                value="<?php echo $info['inb_up_provider1']; ?>"></td>
            <td><input name="inb_up_provider2" id="inb_up_provider2" type="text" style='width:90%;'
                value="<?php echo $info['inb_up_provider2']; ?>"></td>
            <td><input name="inb_up_provider3" id="inb_up_provider3" type="text" style='width:90%;'
                value="<?php echo $info['inb_up_provider3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Upstream Reference ID : </b></td>
            <td><input name="inb_up_refid1" id="inb_up_refid1" type="text" style='width:90%;'
                value="<?php echo $info['inb_up_refid1']; ?>"></td>
            <td><input name="inb_up_refid2" id="inb_up_refid2" type="text" style='width:90%;'
                value="<?php echo $info['inb_up_refid2']; ?>"></td>
            <td><input name="inb_up_refid3" id="inb_up_refid3" type="text" style='width:90%;'
                value="<?php echo $info['inb_up_refid3']; ?>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="inb_com_r_other1" id="inb_com_r_other1" style='width:100%;'>
                ...
                <option value="postcode"
                  <?php echo $info['inb_com_r_other1'] == 'postcode' ? "selected=\"selected\"" : ""; ?>>By Postcode
                </option>
                <option value="state"
                  <?php echo $info['inb_com_r_other1'] == 'state' ? "selected=\"selected\"" : ""; ?>>
                  By State</option>
                <option value="spec_area"
                  <?php echo $info['inb_com_r_other1'] == 'spec_area' ? "selected=\"selected\"" : ""; ?>>By Specified
                  Area
                </option>
                <option value="spec_number"
                  <?php echo $info['inb_com_r_other1'] == 'spec_number' ? "selected=\"selected\"" : ""; ?>>By Specific
                  Numbers</option>
                <option value="other"
                  <?php echo $info['inb_com_r_other1'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select></td>
            <td><select name="inb_com_r_other2" id="inb_com_r_other2" style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="postcode"
                  <?php echo $info['inb_com_r_other2'] == 'postcode' ? "selected=\"selected\"" : ""; ?>>By Postcode
                </option>
                <option value="state"
                  <?php echo $info['inb_com_r_other2'] == 'state' ? "selected=\"selected\"" : ""; ?>>
                  By State</option>
                <option value="spec_area"
                  <?php echo $info['inb_com_r_other2'] == 'spec_area' ? "selected=\"selected\"" : ""; ?>>By Specified
                  Area
                </option>
                <option value="spec_number"
                  <?php echo $info['inb_com_r_other2'] == 'spec_number' ? "selected=\"selected\"" : ""; ?>>By Specific
                  Numbers</option>
                <option value="other"
                  <?php echo $info['inb_com_r_other2'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select></td>
            <td><select name="inb_com_r_other3" id="inb_com_r_other3" style='width:100%;'>
                <option value="">&lt;Select&gt;</option>
                <option value="postcode"
                  <?php echo $info['inb_com_r_other3'] == 'postcode' ? "selected=\"selected\"" : ""; ?>>By Postcode
                </option>
                <option value="state"
                  <?php echo $info['inb_com_r_other3'] == 'state' ? "selected=\"selected\"" : ""; ?>>
                  By State</option>
                <option value="spec_area"
                  <?php echo $info['inb_com_r_other3'] == 'spec_area' ? "selected=\"selected\"" : ""; ?>>By Specified
                  Area
                </option>
                <option value="spec_number"
                  <?php echo $info['inb_com_r_other3'] == 'spec_number' ? "selected=\"selected\"" : ""; ?>>By Specific
                  Numbers</option>
                <option value="other"
                  <?php echo $info['inb_com_r_other3'] == 'other' ? "selected=\"selected\"" : ""; ?>>
                  &lt;Other&gt;</option>
              </select></td>
          </tr>
          <tr>
            <td><b>Routing Other : </b></td>
            <td><input name="inb_routing_other1" id="inb_routing_other1" type="text" style='width:90%;'
                value="<?php echo $info['inb_routing_other1']; ?>"></td>
            <td><input name="inb_routing_other2" id="inb_routing_other2" type="text" style='width:90%;'
                value="<?php echo $info['inb_routing_other2']; ?>"></td>
            <td><input name="inb_routing_other3" id="inb_routing_other3" type="text" style='width:90%;'
                value="<?php echo $info['inb_routing_other3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Date Service Activated : </b></td>
            <td><input name="inb_d_svc_act1" id="inb_d_svc_act1" type="text" style='width:90%;'
                value="<?php echo $info['inb_d_svc_act1']; ?>"></td>
            <td><input name="inb_d_svc_act2" id="inb_d_svc_act2" type="text" style='width:90%;'
                value="<?php echo $info['inb_d_svc_act2']; ?>"></td>
            <td><input name="inb_d_svc_act3" id="inb_d_svc_act3" type="text" style='width:90%;'
                value="<?php echo $info['inb_d_svc_act3']; ?>"></td>
          </tr>
          <tr>
            <td><b>Date Service Cancelled : </b></td>
            <td><input name="inb_d_svc_cancel1" id="inb_d_svc_cancel1" type="text" style='width:90%;'
                value="<?php echo $info['inb_d_svc_cancel1']; ?>"></td>
            <td><input name="inb_d_svc_cancel2" id="inb_d_svc_cancel2" type="text" style='width:90%;'
                value="<?php echo $info['inb_d_svc_cancel2']; ?>"></td>
            <td><input name="inb_d_svc_cancel3" id="inb_d_svc_cancel3" type="text" style='width:90%;'
                value="<?php echo $info['inb_d_svc_cancel3']; ?>"></td>
          </tr>
        </table>
        <!-- table inbound end -->
        <!-- table wifi PC -->
...
displayLicense('<?php echo $siplicense_info['type1']; ?>', '<?php echo $siplicense_info['type2']; ?>',
  '<?php echo $siplicense_info['type3']; ?>',
  '<?php echo $siplicense_info['number1']; ?>', '<?php echo $siplicense_info['number2']; ?>',
  '<?php echo $siplicense_info['number3']; ?>');
<?php } ?>

<?php while ($siphwd_info = db_fetch_array($res3)) { ?>
displayHardware('<?php echo $siphwd_info['type1']; ?>', '<?php echo $siphwd_info['type2']; ?>',
  '<?php echo $siphwd_info['type3']; ?>',
  '<?php echo $siphwd_info['model1']; ?>', '<?php echo $siphwd_info['model2']; ?>',
  '<?php echo $siphwd_info['model3']; ?>',
  '<?php echo $siphwd_info['qty1']; ?>', '<?php echo $siphwd_info['qty2']; ?>',
  '<?php echo $siphwd_info['qty3']; ?>');
<?php } ?>

<?php while ($wifihwd_info = db_fetch_array($res10)) { ?>
displayHardwareWifi('<?php echo $wifihwd_info['ssidname']; ?>', '<?php echo $wifihwd_info['ssidpwd']; ?>',
  '<?php echo $wifihwd_info['svcname']; ?>',
  '<?php echo $wifihwd_info['peip']; ?>', '<?php echo $wifihwd_info['svcother']; ?>',
  '<?php echo $wifihwd_info['peipuser']; ?>',
  '<?php echo $wifihwd_info['devtype']; ?>', '<?php echo $wifihwd_info['peippwd']; ?>',
  '<?php echo $wifihwd_info['devtypeother']; ?>',
  '<?php echo $wifihwd_info['devbrand']; ?>', '<?php echo $wifihwd_info['authip']; ?>',
  '<?php echo $wifihwd_info['devmodel']; ?>',
  '<?php echo $wifihwd_info['authuser']; ?>', '<?php echo $wifihwd_info['devserial']; ?>',
